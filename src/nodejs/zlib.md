...
throwing _after_ the last chunk, not before the first. Each chunk is still
...
[`pipeTo()`]: stream-iter.md#pipetosource-transforms-writer-options
[`pipeline()`]: stream.md#streampipelinesource-transforms-destination-callback
[`pull()`]: stream-iter.md#pullsource-transforms-options
