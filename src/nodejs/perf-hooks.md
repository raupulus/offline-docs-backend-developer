...
[Worker threads]: worker-threads.md#worker-threads
[`'exit'`]: process.md#event-exit
[`child_process.spawnSync()`]: child-process.md#child_processspawnsynccommand-args-options
