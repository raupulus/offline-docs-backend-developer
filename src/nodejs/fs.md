...
[`node:stream/iter`]: stream-iter.md
[`statfs.bsize`]: #statfsbsize
[`stream/iter pipeTo()`]: stream-iter.md#pipetosource-transforms-writer-options
[`stream/iter pull()`]: stream-iter.md#pullsource-transforms-options
[`stream/iter pullSync()`]: stream-iter.md#pullsyncsource-transforms
