...
source_path: diagnostics_channel.md
technology: nodejs
version: main
license: MIT
...
[`locks.request()`]: worker-threads.md#locksrequestname-options-callback
[`net.Server.listen()`]: net.md#serverlisten
[`process.execve()`]: process.md#processexecvefile-args-env
[`start` event]: #startevent
[`worker_threads.locks`]: worker-threads.md#worker_threadslocks
[context loss]: async-context.md#troubleshooting-context-loss
