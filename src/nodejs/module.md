...
[the documentation of `Worker`]: worker-threads.md#new-workerfilename-options
[transferable objects]: worker-threads.md#portpostmessagevalue-transferlist
