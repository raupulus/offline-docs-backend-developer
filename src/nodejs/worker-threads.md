...
[`AsyncResource`]: async-hooks.md#class-asyncresource
...
[`perf_hooks` `eventLoopUtilization()`]: perf-hooks.md#perf_hookseventlooputilizationutilization1-utilization2
...
[async-resource-worker-pool]: async-context.md#using-asyncresource-for-a-worker-thread-pool
