---
title: How do I install untrusted packages safely? Is it safe to run Composer as superuser
  or root?
source_repo: composer/composer
source_ref: main
source_commit: b73133523
source_path: faqs/how-to-install-untrusted-packages-safely.md
technology: composer
version: main
license: MIT
