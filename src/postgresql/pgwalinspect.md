---
title: pg_walinspect — low-level WAL inspection
source_url: https://www.postgresql.org/docs/17/pgwalinspect.html
source_repo: https://github.com/postgres/postgres.git
source_ref: REL_17_STABLE
source_commit: 23088673d
source_path: pgwalinspect.sgml
...
> [!TIP]
> The `pg_filenode_relation` function (see [???](#functions-admin-dblocation)) can help you to determine which relation was modified during original execution.
