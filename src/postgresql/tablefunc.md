---
title: tablefunc — functions that return tables (crosstab and others)
source_url: https://www.postgresql.org/docs/17/tablefunc.html
source_repo: https://github.com/postgres/postgres.git
source_ref: REL_17_STABLE
source_commit: 23088673d
source_path: tablefunc.sgml
...
<caption><code>tablefunc</code> Functions</caption>
<thead>
<tr>
...
<tbody>
<tr>
<td><p role="func_signature"><code>normal_rand</code> ( <code>numvals</code> <code>integer</code>, <code>mean</code> <code>float8</code>, <code>stddev</code> <code>float8</code> ) setof float8</p>
<p>Produces a set of normally distributed random values.</p></td>
</tr>
<tr>
<td><p role="func_signature"><code>crosstab</code> ( <code>sql</code> <code>text</code> ) setof record</p>
<p>Produces a “pivot table” containing row names plus &lt;N&gt; value columns, where &lt;N&gt; is determined by the row type specified in the calling query.</p></td>
</tr>
<tr>
<td><p role="func_signature"><code>crosstabN</code> ( <code>sql</code> <code>text</code> ) setof table_crosstab_&lt;N&gt;</p>
<p>Produces a “pivot table” containing row names plus &lt;N&gt; value columns. <code>crosstab2</code>, <code>crosstab3</code>, and <code>crosstab4</code> are predefined, but you can create additional <code>crosstabN</code> functions as described below.</p></td>
</tr>
<tr>
<td><p role="func_signature"><code>crosstab</code> ( <code>source_sql</code> <code>text</code>, <code>category_sql</code> <code>text</code> ) setof record</p>
<p>Produces a “pivot table” with the value columns specified by a second query.</p></td>
</tr>
<tr>
<td><p role="func_signature"><code>crosstab</code> ( <code>sql</code> <code>text</code>, <code>N</code> <code>integer</code> ) setof record</p>
<p>Obsolete version of <code>crosstab(text)</code>. The parameter <code>N</code> is now ignored, since the number of value columns is always determined by the calling query.</p></td>
</tr>
<tr>
<td><p role="func_signature"><span class="indexterm"></span> <code>connectby</code> ( <code>relname</code> <code>text</code>, <code>keyid_fld</code> <code>text</code>, <code>parent_keyid_fld</code> <code>text</code> [, <code>orderby_fld</code> <code>text</code>], <code>start_with</code> <code>text</code>, <code>max_depth</code> <code>integer</code> [, <code>branch_delim</code> <code>text</code>] ) setof record</p>
<p>Produces a representation of a hierarchical tree structure.</p></td>
</tr>
</tbody>
</table>
...
`connectby` Parameters {#tablefunc-connectby-parameters}
