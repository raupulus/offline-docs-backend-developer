...
source_url: https://www.postgresql.org/docs/17/tutorial-advanced.html
source_repo: https://github.com/postgres/postgres.git
source_ref: REL_17_STABLE
source_commit: 23088673d
source_path: advanced.sgml
...
[^1]: There are options to define the window frame in other ways, but this tutorial does not cover them. See [???](#syntax-window-functions) for details.
