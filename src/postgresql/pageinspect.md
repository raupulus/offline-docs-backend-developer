---
title: pageinspect — low-level inspection of database pages
source_url: https://www.postgresql.org/docs/17/pageinspect.html
source_repo: https://github.com/postgres/postgres.git
source_ref: REL_17_STABLE
source_commit: 23088673d
source_path: pageinspect.sgml
...
`get_raw_page(relname text, fork text, blkno bigint) returns bytea` <span class="indexterm"></span>  
...
`page_header(page bytea) returns record` <span class="indexterm"></span>  
...
`page_checksum(page bytea, blkno bigint) returns smallint` <span class="indexterm"></span>  
...
`fsm_page_contents(page bytea) returns text` <span class="indexterm"></span>  
...
`heap_page_items(page bytea) returns setof record` <span class="indexterm"></span>  
...
`tuple_data_split(rel_oid oid, t_data bytea, t_infomask integer, t_infomask2 integer, t_bits text [, do_detoast bool]) returns bytea[]` <span class="indexterm"></span>  
...
`heap_page_item_attrs(page bytea, rel_oid regclass [, do_detoast bool]) returns setof record` <span class="indexterm"></span>  
...
`heap_tuple_infomask_flags(t_infomask integer, t_infomask2 integer) returns record` <span class="indexterm"></span>  
...
`bt_metap(relname text) returns record` <span class="indexterm"></span>  
...
`bt_page_stats(relname text, blkno bigint) returns record` <span class="indexterm"></span>  
...
`bt_multi_page_stats(relname text, blkno bigint, blk_count bigint) returns setof record` <span class="indexterm"></span>  
...
`bt_page_items(relname text, blkno bigint) returns setof record` <span class="indexterm"></span>  
...
For more details about the structure of B-tree indexes, see [???](#btree-structure). For more details about deduplication and posting lists, see [???](#btree-deduplication).

`bt_page_items(page bytea) returns setof record` <span class="indexterm"></span>  
...
`brin_page_type(page bytea) returns text` <span class="indexterm"></span>  
...
`brin_metapage_info(page bytea) returns record` <span class="indexterm"></span>  
...
`brin_revmap_data(page bytea) returns setof tid` <span class="indexterm"></span>  
...
`brin_page_items(page bytea, index oid) returns setof record` <span class="indexterm"></span>  
...
`gin_metapage_info(page bytea) returns record` <span class="indexterm"></span>  
...
`gin_page_opaque_info(page bytea) returns record` <span class="indexterm"></span>  
...
`gin_leafpage_items(page bytea) returns setof record` <span class="indexterm"></span>  
...
`gist_page_opaque_info(page bytea) returns record` <span class="indexterm"></span>  
...
`gist_page_items(page bytea, index_oid regclass) returns setof record` <span class="indexterm"></span>  
...
`gist_page_items_bytea(page bytea) returns setof record` <span class="indexterm"></span>  
...
`hash_page_type(page bytea) returns text` <span class="indexterm"></span>  
...
`hash_page_stats(page bytea) returns setof record` <span class="indexterm"></span>  
...
`hash_page_items(page bytea) returns setof record` <span class="indexterm"></span>  
...
`hash_bitmap_info(index oid, blkno bigint) returns record` <span class="indexterm"></span>  
...
`hash_metapage_info(page bytea) returns record` <span class="indexterm"></span>  
