---
title: auto_explain — log execution plans of slow queries
source_url: https://www.postgresql.org/docs/17/auto-explain.html
source_repo: https://github.com/postgres/postgres.git
source_ref: REL_17_STABLE
source_commit: 23088673d
source_path: auto-explain.sgml
...
`auto_explain.log_min_duration` (`integer`) <span class="indexterm"></span>  
...
`auto_explain.log_parameter_max_length` (`integer`) <span class="indexterm"></span>  
...
`auto_explain.log_analyze` (`boolean`) <span class="indexterm"></span>  
...
`auto_explain.log_buffers` (`boolean`) <span class="indexterm"></span>  
...
`auto_explain.log_wal` (`boolean`) <span class="indexterm"></span>  
...
`auto_explain.log_timing` (`boolean`) <span class="indexterm"></span>  
...
`auto_explain.log_triggers` (`boolean`) <span class="indexterm"></span>  
...
`auto_explain.log_verbose` (`boolean`) <span class="indexterm"></span>  
...
`auto_explain.log_settings` (`boolean`) <span class="indexterm"></span>  
...
`auto_explain.log_format` (`enum`) <span class="indexterm"></span>  
...
`auto_explain.log_level` (`enum`) <span class="indexterm"></span>  
...
`auto_explain.log_nested_statements` (`boolean`) <span class="indexterm"></span>  
...
`auto_explain.sample_rate` (`real`) <span class="indexterm"></span>  
