---
title: SQL Key Words
source_url: https://www.postgresql.org/docs/17/sql-keywords-appendix.html
source_repo: https://github.com/postgres/postgres.git
source_ref: REL_17_STABLE
source_commit: 23088673d
source_path: keywords.sgml
...
[???](#keywords-table) lists all tokens that are key words in the SQL standard and in PostgreSQL . Background information can be found in [???](#sql-syntax-identifiers). (For space reasons, only the latest two versions of the SQL standard, and SQL-92 for historical comparison, are included. The differences between those and the other intermediate standard versions are small.)
