...
source_url: https://www.postgresql.org/docs/17/tutorial-start.html
source_repo: https://github.com/postgres/postgres.git
source_ref: REL_17_STABLE
source_commit: 23088673d
source_path: start.sgml
...
- A server process, which manages the database files, accepts connections to the database from client applications, and performs database actions on behalf of the clients. The database server program is called `postgres`. <span class="indexterm"></span>
...
<span class="indexterm"></span> The last line could also be:
...
The last line printed out by `psql` is the prompt, and it indicates that `psql` is listening to you and that you can type SQL queries into a work space maintained by `psql`. Try out these commands: <span class="indexterm"></span>
