...
source_url: https://www.postgresql.org/docs/17/sql-createrule.html
source_repo: https://github.com/postgres/postgres.git
source_ref: REL_17_STABLE
source_commit: 23088673d
source_path: ref/create_rule.sgml
...
> [!NOTE]
> A view that is simple enough to be automatically updatable (see [???](#sql-createview)) does not require a user-created rule in order to be updatable. While you can create an explicit rule anyway, the automatic update transformation will generally outperform an explicit rule.
>
> Another alternative worth considering is to use `INSTEAD OF` triggers (see [???](#sql-createtrigger)) in place of rules.
