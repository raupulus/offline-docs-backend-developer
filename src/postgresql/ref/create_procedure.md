...
source_url: https://www.postgresql.org/docs/17/sql-createprocedure.html
source_repo: https://github.com/postgres/postgres.git
source_ref: REL_17_STABLE
source_commit: 23088673d
source_path: ref/create_procedure.sgml
...
} \[, ... \] \| \[ EXTERNAL \] SECURITY INVOKER \| \[ EXTERNAL \] SECURITY DEFINER \| SET
...
It is often helpful to use dollar quoting (see [???](#sql-syntax-dollar-quoting)) to write the procedure definition string, rather than the normal single quote syntax. Without dollar quoting, any single quotes or backslashes in the procedure definition must be escaped by doubling them.
