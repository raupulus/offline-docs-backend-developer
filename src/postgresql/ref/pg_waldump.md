---
title: pg_waldump
description: display a human-readable rendering of the write-ahead log of a PostgreSQL
  database cluster
source_url: https://www.postgresql.org/docs/17/pgwaldump.html
source_repo: https://github.com/postgres/postgres.git
source_ref: REL_17_STABLE
source_commit: 23088673d
source_path: ref/pg_waldump.sgml
...
If pg_waldump is terminated by signal `SIGINT` (<span class="keycombo">Control+C</span>), the summary of the statistics computed is displayed up to the termination point. This operation is not supported on Windows.
