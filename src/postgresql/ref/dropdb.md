...
source_url: https://www.postgresql.org/docs/17/app-dropdb.html
source_repo: https://github.com/postgres/postgres.git
source_ref: REL_17_STABLE
source_commit: 23088673d
source_path: ref/dropdb.sgml
...
`-f`; `--force`  
Attempt to terminate all existing connections to the target database before dropping it. See [???](#sql-dropdatabase) for more information on this option.
