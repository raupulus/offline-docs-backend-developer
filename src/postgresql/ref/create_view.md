...
source_url: https://www.postgresql.org/docs/17/sql-createview.html
source_repo: https://github.com/postgres/postgres.git
source_ref: REL_17_STABLE
source_commit: 23088673d
source_path: ref/create_view.sgml
...
`RECURSIVE` <span class="indexterm"></span>  
...
`WITH [ CASCADED | LOCAL ] CHECK OPTION` <span class="indexterm"></span> <span class="indexterm"></span>  
