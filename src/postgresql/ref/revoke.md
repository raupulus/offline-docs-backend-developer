...
source_url: https://www.postgresql.org/docs/17/sql-revoke.html
source_repo: https://github.com/postgres/postgres.git
source_ref: REL_17_STABLE
source_commit: 23088673d
source_path: ref/revoke.sgml
...
REVOKE \[ GRANT OPTION FOR \] { { SELECT \| INSERT \| UPDATE \| DELETE \| TRUNCATE \| REFERENCES \| TRIGGER \| MAINTAIN } \[, ...\] \| ALL \[ PRIVILEGES \] } ON { \[ TABLE \]
...
\] \[ CASCADE \| RESTRICT \] REVOKE \[ GRANT OPTION FOR \] { { SELECT \| INSERT \| UPDATE \| REFERENCES } (
...
\] \[ CASCADE \| RESTRICT \] REVOKE \[ GRANT OPTION FOR \] { { USAGE \| SELECT \| UPDATE } \[, ...\] \| ALL \[ PRIVILEGES \] } ON { SEQUENCE
...
\] \[ CASCADE \| RESTRICT \] REVOKE \[ GRANT OPTION FOR \] { { CREATE \| CONNECT \| TEMPORARY \| TEMP } \[, ...\] \| ALL \[ PRIVILEGES \] } ON DATABASE
...
\] \[ CASCADE \| RESTRICT \] REVOKE \[ GRANT OPTION FOR \] { USAGE \| ALL \[ PRIVILEGES \] } ON DOMAIN
...
\] \[ CASCADE \| RESTRICT \] REVOKE \[ GRANT OPTION FOR \] { USAGE \| ALL \[ PRIVILEGES \] } ON FOREIGN DATA WRAPPER
...
\] \[ CASCADE \| RESTRICT \] REVOKE \[ GRANT OPTION FOR \] { USAGE \| ALL \[ PRIVILEGES \] } ON FOREIGN SERVER
...
\] \[ CASCADE \| RESTRICT \] REVOKE \[ GRANT OPTION FOR \] { EXECUTE \| ALL \[ PRIVILEGES \] } ON { { FUNCTION \| PROCEDURE \| ROUTINE }
...
\] \[ CASCADE \| RESTRICT \] REVOKE \[ GRANT OPTION FOR \] { USAGE \| ALL \[ PRIVILEGES \] } ON LANGUAGE
...
\] \[ CASCADE \| RESTRICT \] REVOKE \[ GRANT OPTION FOR \] { { SELECT \| UPDATE } \[, ...\] \| ALL \[ PRIVILEGES \] } ON LARGE OBJECT
...
\] \[ CASCADE \| RESTRICT \] REVOKE \[ GRANT OPTION FOR \] { { SET \| ALTER SYSTEM } \[, ...\] \| ALL \[ PRIVILEGES \] } ON PARAMETER
...
\] \[ CASCADE \| RESTRICT \] REVOKE \[ GRANT OPTION FOR \] { { CREATE \| USAGE } \[, ...\] \| ALL \[ PRIVILEGES \] } ON SCHEMA
...
\] \[ CASCADE \| RESTRICT \] REVOKE \[ GRANT OPTION FOR \] { CREATE \| ALL \[ PRIVILEGES \] } ON TABLESPACE
...
\] \[ CASCADE \| RESTRICT \] REVOKE \[ GRANT OPTION FOR \] { USAGE \| ALL \[ PRIVILEGES \] } ON TYPE
...
\] \[ CASCADE \| RESTRICT \] REVOKE \[ { ADMIN \| INHERIT \| SET } OPTION FOR \]
