...
source_url: https://www.postgresql.org/docs/17/sql-createtableas.html
source_repo: https://github.com/postgres/postgres.git
source_ref: REL_17_STABLE
source_commit: 23088673d
source_path: ref/create_table_as.sgml
...
\<query\>  
A [`SELECT`](#sql-select), [`TABLE`](#sql-table), or [`VALUES`](#sql-values) command, or an [`EXECUTE`](#sql-execute) command that runs a prepared `SELECT`, `TABLE`, or `VALUES` query.
...
- PostgreSQL handles temporary tables in a way rather different from the standard; see [???](#sql-createtable) for details.
