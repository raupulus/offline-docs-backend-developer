...
description: set the session user identifier and the current user identifier of the
  current session
source_url: https://www.postgresql.org/docs/17/sql-set-session-authorization.html
source_repo: https://github.com/postgres/postgres.git
source_ref: REL_17_STABLE
source_commit: 23088673d
source_path: ref/set_session_auth.sgml
