...
source_url: https://www.postgresql.org/docs/17/sql-grant.html
source_repo: https://github.com/postgres/postgres.git
source_ref: REL_17_STABLE
source_commit: 23088673d
source_path: ref/grant.sgml
...
GRANT { { SELECT \| INSERT \| UPDATE \| DELETE \| TRUNCATE \| REFERENCES \| TRIGGER \| MAINTAIN } \[, ...\] \| ALL \[ PRIVILEGES \] } ON { \[ TABLE \]
...
\] GRANT { { USAGE \| SELECT \| UPDATE } \[, ...\] \| ALL \[ PRIVILEGES \] } ON { SEQUENCE
...
\] GRANT { USAGE \| ALL \[ PRIVILEGES \] } ON DOMAIN
...
\] GRANT { USAGE \| ALL \[ PRIVILEGES \] } ON FOREIGN DATA WRAPPER
...
\] GRANT { USAGE \| ALL \[ PRIVILEGES \] } ON FOREIGN SERVER
...
\] GRANT { EXECUTE \| ALL \[ PRIVILEGES \] } ON { { FUNCTION \| PROCEDURE \| ROUTINE }
...
\] GRANT { USAGE \| ALL \[ PRIVILEGES \] } ON LANGUAGE
...
\] GRANT { { SELECT \| UPDATE } \[, ...\] \| ALL \[ PRIVILEGES \] } ON LARGE OBJECT
...
\] GRANT { { CREATE \| USAGE } \[, ...\] \| ALL \[ PRIVILEGES \] } ON SCHEMA
...
\] GRANT { CREATE \| ALL \[ PRIVILEGES \] } ON TABLESPACE
...
\] GRANT { USAGE \| ALL \[ PRIVILEGES \] } ON TYPE
...
\[, ...\] \[ WITH { ADMIN \| INHERIT \| SET } { OPTION \| TRUE \| FALSE } \] \[ GRANTED BY
...
Specific types of privileges, as defined in [???](#ddl-priv).
