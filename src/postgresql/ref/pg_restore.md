...
source_url: https://www.postgresql.org/docs/17/app-pgrestore.html
source_repo: https://github.com/postgres/postgres.git
source_ref: REL_17_STABLE
source_commit: 23088673d
source_path: ref/pg_restore.sgml
...
Once restored, it is wise to run `ANALYZE` on each restored table so the optimizer has useful statistics; see [???](#vacuum-for-statistics) and [???](#autovacuum) for more information.
