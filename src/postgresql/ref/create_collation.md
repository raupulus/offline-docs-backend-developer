...
source_url: https://www.postgresql.org/docs/17/sql-createcollation.html
source_repo: https://github.com/postgres/postgres.git
source_ref: REL_17_STABLE
source_commit: 23088673d
source_path: ref/create_collation.sgml
...
\<locale\>  
The locale name for this collation. See [???](#collation-managing-create-libc) and [???](#collation-managing-create-icu) for details.
...
\<provider\>  
Specifies the provider to use for locale services associated with this collation. Possible values are `builtin`, `icu`<span class="indexterm"></span> (if the server was built with ICU support) or `libc`. `libc` is the default. See [???](#locale-providers) for details.
...
See also [???](#sql-altercollation) for how to handle collation version mismatches.
