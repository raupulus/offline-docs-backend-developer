...
source_url: https://www.postgresql.org/docs/17/app-pgreceivewal.html
source_repo: https://github.com/postgres/postgres.git
source_ref: REL_17_STABLE
source_commit: 23088673d
source_path: ref/pg_receivewal.sgml
...
In the absence of fatal errors, pg_receivewal will run until terminated by the `SIGINT` (<span class="keycombo">Control+C</span>) or `SIGTERM` signal.
