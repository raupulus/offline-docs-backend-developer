---
title: pg_resetwal
description: reset the write-ahead log and other control information of a PostgreSQL
  database cluster
source_url: https://www.postgresql.org/docs/17/app-pgresetwal.html
source_repo: https://github.com/postgres/postgres.git
source_ref: REL_17_STABLE
source_commit: 23088673d
source_path: ref/pg_resetwal.sgml
...
Set the new WAL segment size, in megabytes. The value must be set to a power of 2 between 1 and 1024 (megabytes). See the same option of [???](#app-initdb) for more information.
