...
source_url: https://www.postgresql.org/docs/17/sql-cluster.html
source_repo: https://github.com/postgres/postgres.git
source_ref: REL_17_STABLE
source_commit: 23088673d
source_path: ref/cluster.sgml
...
It is advisable to set [???](#guc-maintenance-work-mem) to a reasonably large value (but not more than the amount of RAM you can dedicate to the `CLUSTER` operation) before clustering.
