...
source_url: https://www.postgresql.org/docs/17/sql-createdomain.html
source_repo: https://github.com/postgres/postgres.git
source_ref: REL_17_STABLE
source_commit: 23088673d
source_path: ref/create_domain.sgml
...
The syntax `NOT NULL` in this command is a PostgreSQL extension. (A standard-conforming way to write the same for non-composite data types would be `CHECK (VALUE IS NOT NULL)`. However, per [refsect1_title](#sql-createdomain-notes), such constraints are best avoided in practice anyway.) The `NULL` “constraint” is a PostgreSQL extension (see also [???](#sql-createtable-compatibility)).
