...
source_url: https://www.postgresql.org/docs/17/sql-insert.html
source_repo: https://github.com/postgres/postgres.git
source_ref: REL_17_STABLE
source_commit: 23088673d
source_path: ref/insert.sgml
...
\[, ...\] ) \] \[ OVERRIDING { SYSTEM \| USER } VALUE \] { DEFAULT VALUES \| VALUES ( {
...
\<with_query\>  
The `WITH` clause allows you to specify one or more subqueries that can be referenced by name in the `INSERT` query. See [???](#queries-with) and [???](#sql-select) for details.
