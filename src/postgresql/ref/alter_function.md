...
source_url: https://www.postgresql.org/docs/17/sql-alterfunction.html
source_repo: https://github.com/postgres/postgres.git
source_ref: REL_17_STABLE
source_commit: 23088673d
source_path: ref/alter_function.sgml
...
\| CURRENT_ROLE \| CURRENT_USER \| SESSION_USER } ALTER FUNCTION
...
CALLED ON NULL INPUT \| RETURNS NULL ON NULL INPUT \| STRICT IMMUTABLE \| STABLE \| VOLATILE \[ NOT \] LEAKPROOF \[ EXTERNAL \] SECURITY INVOKER \| \[ EXTERNAL \] SECURITY DEFINER PARALLEL { UNSAFE \| RESTRICTED \| SAFE } COST
...
Set or change the planner support function to use for this function. See [???](#xfunc-optimization) for details. You must be superuser to use this option.
