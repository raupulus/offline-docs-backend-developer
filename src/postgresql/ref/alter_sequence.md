...
source_url: https://www.postgresql.org/docs/17/sql-altersequence.html
source_repo: https://github.com/postgres/postgres.git
source_ref: REL_17_STABLE
source_commit: 23088673d
source_path: ref/alter_sequence.sgml
...
\| NONE } \] ALTER SEQUENCE \[ IF EXISTS \]

name

SET { LOGGED \| UNLOGGED } ALTER SEQUENCE \[ IF EXISTS \]
...
\| CURRENT_ROLE \| CURRENT_USER \| SESSION_USER } ALTER SEQUENCE \[ IF EXISTS \]
...
`SET { LOGGED | UNLOGGED }`  
This form changes the sequence from unlogged to logged or vice-versa (see [???](#sql-createsequence)). It cannot be applied to a temporary sequence.
