...
source_url: https://www.postgresql.org/docs/17/btree-gist.html
source_repo: https://github.com/postgres/postgres.git
source_ref: REL_17_STABLE
source_commit: 23088673d
source_path: btree-gist.sgml
...
In addition to the typical B-tree search operators, `btree_gist` also provides index support for `<>` (“not equals”). This may be useful in combination with an [exclusion constraint](#sql-createtable-exclude), as described below.
