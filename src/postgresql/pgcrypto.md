---
title: pgcrypto — cryptographic functions
source_url: https://www.postgresql.org/docs/17/pgcrypto.html
source_repo: https://github.com/postgres/postgres.git
source_ref: REL_17_STABLE
source_commit: 23088673d
source_path: pgcrypto.sgml
...
Supported Algorithms for `crypt()` {#pgcrypto-crypt-algorithms}
...
Iteration Counts for `crypt()` {#pgcrypto-icfc-table}
...
Hash Algorithm Speeds {#pgcrypto-hash-speed-table}
