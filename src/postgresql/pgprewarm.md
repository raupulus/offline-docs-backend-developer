...
source_url: https://www.postgresql.org/docs/17/pgprewarm.html
source_repo: https://github.com/postgres/postgres.git
source_ref: REL_17_STABLE
source_commit: 23088673d
source_path: pgprewarm.sgml
...
`pg_prewarm.autoprewarm` (`boolean`) <span class="indexterm"></span>  
...
`pg_prewarm.autoprewarm_interval` (`integer`) <span class="indexterm"></span>  
