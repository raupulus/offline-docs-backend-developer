---
title: file_fdw — access data files in the server's file system
source_url: https://www.postgresql.org/docs/17/file-fdw.html
source_repo: https://github.com/postgres/postgres.git
source_ref: REL_17_STABLE
source_commit: 23088673d
source_path: file-fdw.sgml
...
One of the obvious uses for `file_fdw` is to make the PostgreSQL activity log available as a table for querying. To do this, first you must be [logging to a CSV file,](#runtime-config-logging-csvlog) which here we will call `pglog.csv`. First, install `file_fdw` as an extension:
