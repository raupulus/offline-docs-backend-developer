...
source_url: https://www.postgresql.org/docs/17/pgfreespacemap.html
source_repo: https://github.com/postgres/postgres.git
source_ref: REL_17_STABLE
source_commit: 23088673d
source_path: pgfreespacemap.sgml
...
`pg_freespace(rel regclass IN, blkno bigint IN) returns int2` <span class="indexterm"></span>  
