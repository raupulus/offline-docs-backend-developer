...
source_url: https://www.postgresql.org/docs/17/limits.html
source_repo: https://github.com/postgres/postgres.git
source_ref: REL_17_STABLE
source_commit: 23088673d
source_path: limits.sgml
...
[ Limitations](#limits-table) describes various hard limits of PostgreSQL. However, practical limits, such as performance limitations or available disk space may apply before absolute hard limits are reached.
...
PostgreSQL Limitations {#limits-table}
