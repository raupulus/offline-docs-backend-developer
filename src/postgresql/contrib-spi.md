---
title: spi — Server Programming Interface features/examples
source_url: https://www.postgresql.org/docs/17/contrib-spi.html
source_repo: https://github.com/postgres/postgres.git
source_ref: REL_17_STABLE
source_commit: 23088673d
source_path: contrib-spi.sgml
...
> [!NOTE]
> `refint` requires a [secure schema usage pattern](#ddl-schemas-patterns) and data types where the equality operator is named `=`.
