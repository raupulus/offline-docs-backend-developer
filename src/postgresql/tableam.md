...
source_url: https://www.postgresql.org/docs/17/tableam.html
source_repo: https://github.com/postgres/postgres.git
source_ref: REL_17_STABLE
source_commit: 23088673d
source_path: tableam.sgml
...
Each table access method is described by a row in the [pg_am](#catalog-pg-am) system catalog. The pg_am entry specifies a name and a handler function for the table access method. These entries can be created and deleted using the [???](#sql-create-access-method) and [???](#sql-drop-access-method) SQL commands.
