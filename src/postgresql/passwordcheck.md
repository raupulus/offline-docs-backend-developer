---
title: passwordcheck — verify password strength
source_url: https://www.postgresql.org/docs/17/passwordcheck.html
source_repo: https://github.com/postgres/postgres.git
source_ref: REL_17_STABLE
source_commit: 23088673d
source_path: passwordcheck.sgml
...
>
> This limits the usefulness of the `passwordcheck` module, because in that case it can only try to guess the password. For this reason, `passwordcheck` is not recommended if your security requirements are high. It is more secure to use an external authentication method such as GSSAPI (see [???](#client-authentication)) than to rely on passwords within the database.
>
