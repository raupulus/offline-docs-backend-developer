---
title: pgstattuple — obtain tuple-level statistics
source_url: https://www.postgresql.org/docs/17/pgstattuple.html
source_repo: https://github.com/postgres/postgres.git
source_ref: REL_17_STABLE
source_commit: 23088673d
source_path: pgstattuple.sgml
...
<span class="indexterm"></span> `pgstattuple(regclass) returns record`  
...
`pgstattuple` Output Columns {#pgstattuple-columns}
...
<span class="indexterm"></span> `pgstatindex(regclass) returns record`  
...
<span class="indexterm"></span> `pgstatginindex(regclass) returns record`  
...
<span class="indexterm"></span> `pgstathashindex(regclass) returns record`  
...
<span class="indexterm"></span> `pg_relpages(regclass) returns bigint`  
...
<span class="indexterm"></span> `pgstattuple_approx(regclass) returns record`  
...
`pgstattuple_approx` Output Columns {#pgstatapprox-columns}
