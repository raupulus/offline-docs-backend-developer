---
title: gitpacking
description: Advanced concepts related to packing in Git
source_url: https://git-scm.com/doc/gitpacking
source_repo: https://github.com/git/git.git
source_ref: master
source_commit: 339ab2a8f
source_path: gitpacking.adoc
technology: git
version: master
license: GPL-2.0
...
NAME ---- gitpacking - Advanced concepts related to packing in Git
...
Many concepts are currently described scattered between manual pages of various Git commands, including [git-pack-objects](git-pack-objects.md), [git-repack](git-repack.md), and others, as well as [gitformat-pack](gitformat-pack.md), and parts of the `Documentation/technical` tree.
