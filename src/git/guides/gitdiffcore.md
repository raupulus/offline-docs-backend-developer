...
source_url: https://git-scm.com/doc/gitdiffcore
source_repo: https://github.com/git/git.git
source_ref: master
source_commit: 339ab2a8f
source_path: gitdiffcore.adoc
technology: git
version: master
license: GPL-2.0
...
NAME ---- gitdiffcore - Tweaking diff output
...
SEE ALSO -------- [git-diff](git-diff.md), [git-diff-files](git-diff-files.md), [git-diff-index](git-diff-index.md), [git-diff-tree](git-diff-tree.md), [git-format-patch](git-format-patch.md), [git-log](git-log.md), [gitglossary](gitglossary.md), [The Git User’s Manual](user-manual.html)
