---
title: separating-topic-branches
source_url: https://git-scm.com/doc/separating-topic-branches
source_repo: https://github.com/git/git.git
source_ref: master
source_commit: 339ab2a8f
source_path: howto/separating-topic-branches.adoc
technology: git
version: master
license: GPL-2.0
...
From: Junio C Hamano \<[gitster@pobox.com](gitster@pobox.com)\> Subject: Separating topic branches Abstract: In this article, JC describes how to separate topic branches. Content-type: text/asciidoc
...
The last diff better not to show anything other than cleanups for cruft. Then I can finally clean things up:
