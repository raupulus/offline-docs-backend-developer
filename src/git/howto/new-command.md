---
title: new-command
source_url: https://git-scm.com/doc/new-command
source_repo: https://github.com/git/git.git
source_ref: master
source_commit: 339ab2a8f
source_path: howto/new-command.adoc
technology: git
version: master
license: GPL-2.0
...
From: Eric S. Raymond \<[esr@thyrsus.com](esr@thyrsus.com)\> Abstract: This is how-to documentation for people who want to add extension commands to Git. It should be read alongside builtin.h. Content-type: text/asciidoc

How to integrate new subcommands ================================

This is how-to documentation for people who want to add extension commands to Git. It should be read alongside builtin.h.
