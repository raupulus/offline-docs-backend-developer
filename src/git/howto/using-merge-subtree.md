---
title: using-merge-subtree
source_url: https://git-scm.com/doc/using-merge-subtree
source_repo: https://github.com/git/git.git
source_ref: master
source_commit: 339ab2a8f
source_path: howto/using-merge-subtree.adoc
technology: git
version: master
license: GPL-2.0
...
Date: Sat, 5 Jan 2008 20:17:40 -0500 From: Sean \<[seanlkml@sympatico.ca](seanlkml@sympatico.ca)\> To: Miklos Vajna \<[vmiklos@frugalware.org](vmiklos@frugalware.org)\> Cc: git@vger.kernel.org Subject: how to use git merge -s subtree? Abstract: In this article, Sean demonstrates how one can use the subtree merge strategy. Content-type: text/asciidoc Message-ID: \<BAYC1-[PASMTP12374B54BA370A1E1C6E78AE4E0@CEZ.ICE](PASMTP12374B54BA370A1E1C6E78AE4E0@CEZ.ICE)\>

How to use the subtree merge strategy =====================================

There are situations where you want to include content in your project from an independently developed project. You can just pull from the other project as long as there are no conflicting paths.
