---
title: using-signed-tag-in-pull-request
source_url: https://git-scm.com/doc/using-signed-tag-in-pull-request
source_repo: https://github.com/git/git.git
source_ref: master
source_commit: 339ab2a8f
source_path: howto/using-signed-tag-in-pull-request.adoc
technology: git
version: master
license: GPL-2.0
...
From: Junio C Hamano \<[gitster@pobox.com](gitster@pobox.com)\> Date: Tue, 17 Jan 2011 13:00:00 -0800 Subject: Using signed tag in pull requests Abstract: Beginning v1.7.9, a contributor can push a signed tag to her publishing repository and ask her integrator to pull it. This assures the integrator that the pulled history is authentic and allows others to later validate it. Content-type: text/asciidoc
