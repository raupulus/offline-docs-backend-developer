---
title: $(id -u -n)
source_url: https://git-scm.com/doc/update-hook-example
source_repo: https://github.com/git/git.git
source_ref: master
source_commit: 339ab2a8f
source_path: howto/update-hook-example.adoc
technology: git
version: master
license: GPL-2.0
...
From: Junio C Hamano \<[gitster@pobox.com](gitster@pobox.com)\> and Carl Baldwin \<[cnb@fc.hp](cnb@fc.hp).com\> Subject: control access to branches. Date: Thu, 17 Nov 2005 23:55:32 -0800 Message-ID: \<7vfypumlu3.fsf@assigned-by-dhcp.cox.net\> Abstract: An example hooks/update script is presented to implement repository maintenance policies, such as who can push into which branch and who can make a tag. Content-type: text/asciidoc
...
With this, Linus can push or create "bw/penguin" or "bw/zebra" or "bw/panda" branches, Pasky can do only "cogito", and JC can do master and "seen" branches and make versioned tags. And anybody can do tmp/blah branches. The ’+’ sign at the "seen" record means that JC can make non-fast-forward pushes on it.
