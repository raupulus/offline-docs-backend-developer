...
source_url: https://git-scm.com/doc/git-quiltimport
source_repo: https://github.com/git/git.git
source_ref: master
source_commit: 339ab2a8f
source_path: git-quiltimport.adoc
technology: git
version: master
license: GPL-2.0
...
NAME ---- git-quiltimport - Applies a quilt patchset onto the current branch
...
DESCRIPTION ----------- Applies a quilt patchset onto the current Git branch, preserving the patch boundaries, patch order, and patch descriptions present in the quilt patchset.
...
--keep-non-patch  
Pass `-b` flag to ’git mailinfo’ (see [git-mailinfo](git-mailinfo.md)).
