...
source_url: https://git-scm.com/doc/git-upload-archive
source_repo: https://github.com/git/git.git
source_ref: master
source_commit: 339ab2a8f
source_path: git-upload-archive.adoc
technology: git
version: master
license: GPL-2.0
...
DESCRIPTION ----------- Invoked by ’git archive --remote’ and sends a generated archive to the other end over the Git protocol.
...
OPTIONS ------- \<repository\>:: The repository to get a tar archive from.
