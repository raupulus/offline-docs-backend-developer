...
source_url: https://git-scm.com/doc/git-cvsimport
source_repo: https://github.com/git/git.git
source_ref: master
source_commit: 339ab2a8f
source_path: git-cvsimport.adoc
technology: git
version: master
license: GPL-2.0
...
NAME ---- git-cvsimport - Salvage your data out of another SCM people love to hate
...
DESCRIPTION ----------- **WARNING:** `git` `cvsimport` uses cvsps version 2, which is considered deprecated; it does not work with cvsps version 3 and later. If you are performing a one-shot import of a CVS repository consider using [cvs2git](http://cvs2svn.tigris.org/cvs2git.html) or [cvs-fast-export](https://gitlab.com/esr/cvs-fast-export).
...
**WARNING:** for certain situations the import leads to incorrect results. Please see the section <a href="#issues" class="cross-reference">ISSUES</a> for further reference.
...
If you intend to set up a shared public repository that all developers can read/write, or if you want to use [git-cvsserver](git-cvsserver.md), then you probably want to make a bare clone of the imported repository, and use the clone as the shared repository. See [gitcvs-migration](gitcvs-migration.md).

OPTIONS ------- -v:: Verbosity: let ’cvsimport’ report what it is doing.
...
OUTPUT ------ If `-v` is specified, the script reports what it is doing.

Otherwise, success is indicated the Unix way, i.e. by simply exiting with a zero exit status.

<div id="issues" data-wrapper="1">

ISSUES ------ Problems related to timestamps:
...
- cvs2git (part of cvs2svn), [`https://subversion.apache.org/`](https://subversion.apache.org/)
