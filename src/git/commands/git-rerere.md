...
source_url: https://git-scm.com/doc/git-rerere
source_repo: https://github.com/git/git.git
source_ref: master
source_commit: 339ab2a8f
source_path: git-rerere.adoc
technology: git
version: master
license: GPL-2.0
...
Normally, ’git rerere’ is run without arguments or user-intervention. However, it has several commands that allow users to interact with its working state.
...
Reset the conflict resolutions which rerere has recorded for the current conflicts in paths that match \<pathspec\>.
