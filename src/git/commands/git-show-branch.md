...
source_url: https://git-scm.com/doc/git-show-branch
source_repo: https://github.com/git/git.git
source_ref: master
source_commit: 339ab2a8f
source_path: git-show-branch.adoc
technology: git
version: master
license: GPL-2.0
...
OPTIONS ------- \<rev\>:: Arbitrary extended SHA-1 expression (see [gitrevisions](gitrevisions.md)) that typically names a branch head or a tag.
...
--merge-base  
Instead of showing the commit list, determine possible merge bases for the specified commits. All merge bases will be contained in all specified commits. This is different from how [git-merge-base](git-merge-base.md) handles the case of three or more commits.
