---
title: git-patch-id
description: Compute unique IDs for patches
source_url: https://git-scm.com/doc/git-patch-id
source_repo: https://github.com/git/git.git
source_ref: master
source_commit: 339ab2a8f
source_path: git-patch-id.adoc
technology: git
version: master
license: GPL-2.0
...
NAME ---- git-patch-id - Compute unique IDs for patches

SYNOPSIS --------

git patch-id \[--stable \| --unstable \| --verbatim\]

DESCRIPTION ----------- Read patches from standard input and compute the patch IDs.
...
[git-cherry](git-cherry.md) shows what commits from a branch have patch ID equivalent commits in some upstream branch. But it only tells you whether such a commit exists or not. What if you wanted to know the relevant commits in the upstream? We can use this command to make a mapping between your branch and the upstream branch:
...
SEE ALSO -------- [git-cherry](git-cherry.md)
