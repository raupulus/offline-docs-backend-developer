...
source_url: https://git-scm.com/doc/git-shell
source_repo: https://github.com/git/git.git
source_ref: master
source_commit: 339ab2a8f
source_path: git-shell.adoc
technology: git
version: master
license: GPL-2.0
...
’cvs server’  
Imitate a CVS server. See [git-cvsserver](git-cvsserver.md).
...
SEE ALSO -------- ssh(1), [git-daemon](git-daemon.md), contrib/git-shell-commands/README
