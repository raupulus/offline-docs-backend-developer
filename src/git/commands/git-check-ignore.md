...
source_url: https://git-scm.com/doc/git-check-ignore
source_repo: https://github.com/git/git.git
source_ref: master
source_commit: 339ab2a8f
source_path: git-check-ignore.adoc
technology: git
version: master
license: GPL-2.0
...
OPTIONS ------- -q:: --quiet:: Don’t output anything, just set exit status. This is only valid with a single pathname.
...
For precedence rules within and between exclude sources, see [gitignore](gitignore.md).
...
SEE ALSO -------- [gitignore](gitignore.md) [git-config](git-config.md) [git-ls-files](git-ls-files.md)
