...
source_url: https://git-scm.com/doc/git-commit-tree
source_repo: https://github.com/git/git.git
source_ref: master
source_commit: 339ab2a8f
source_path: git-commit-tree.adoc
technology: git
version: master
license: GPL-2.0
...
DESCRIPTION ----------- This is usually not what an end user wants to run directly. See [git-commit](git-commit.md) instead.
...
SEE ALSO -------- [git-write-tree](git-write-tree.md) [git-commit](git-commit.md)
