...
source_url: https://git-scm.com/doc/git-stripspace
source_repo: https://github.com/git/git.git
source_ref: master
source_commit: 339ab2a8f
source_path: git-stripspace.adoc
technology: git
version: master
license: GPL-2.0
...
**NOTE**: This is intended for cleaning metadata. Prefer the `--whitespace=fix` mode of [git-apply](git-apply.md) for correcting whitespace of patches or files in the repository.

OPTIONS ------- -s:: --strip-comments:: Skip and remove all lines starting with a comment character (`core.commentChar`, default `#`).
