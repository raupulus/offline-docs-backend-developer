...
source_url: https://git-scm.com/doc/git-diff-tree
source_repo: https://github.com/git/git.git
source_ref: master
source_commit: 339ab2a8f
source_path: git-diff-tree.adoc
technology: git
version: master
license: GPL-2.0
...
NAME ---- git-diff-tree - Compares the content and mode of blobs found via two tree objects
...
DESCRIPTION ----------- Compare the content and mode of blobs found via two tree objects.
