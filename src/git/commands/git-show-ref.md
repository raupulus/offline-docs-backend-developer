...
source_url: https://git-scm.com/doc/git-show-ref
source_repo: https://github.com/git/git.git
source_ref: master
source_commit: 339ab2a8f
source_path: git-show-ref.adoc
technology: git
version: master
license: GPL-2.0
...
SEE ALSO -------- [git-for-each-ref](git-for-each-ref.md), [git-ls-remote](git-ls-remote.md), [git-update-ref](git-update-ref.md), [gitrepository-layout](gitrepository-layout.md)
