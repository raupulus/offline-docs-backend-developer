...
source_url: https://git-scm.com/doc/git-cvsexportcommit
source_repo: https://github.com/git/git.git
source_ref: master
source_commit: 339ab2a8f
source_path: git-cvsexportcommit.adoc
technology: git
version: master
license: GPL-2.0
...
DESCRIPTION ----------- Exports a commit from Git to a CVS checkout, making it easier to merge patches from a Git repository into a CVS repository.
...
CONFIGURATION ------------- cvsexportcommit.cvsdir:: The default location of the CVS checkout to use for the export.
