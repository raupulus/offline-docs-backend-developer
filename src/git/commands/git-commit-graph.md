...
source_url: https://git-scm.com/doc/git-commit-graph
source_repo: https://github.com/git/git.git
source_ref: master
source_commit: 339ab2a8f
source_path: git-commit-graph.adoc
technology: git
version: master
license: GPL-2.0
...
The existence of replace objects or commit grafts turns off reading or writing to the commit-graph. See [git-replace](git-replace.md).
...
see [gitformat-commit-graph](gitformat-commit-graph.md).
