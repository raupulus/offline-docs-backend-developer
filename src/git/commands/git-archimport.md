...
source_url: https://git-scm.com/doc/git-archimport
source_repo: https://github.com/git/git.git
source_ref: master
source_commit: 339ab2a8f
source_path: git-archimport.adoc
technology: git
version: master
license: GPL-2.0
...
MERGES ------ Patch merge data from Arch is used to mark merges in Git as well. Git does not care much about tracking patches, and only considers a merge when a branch incorporates all the commits since the point they forked. The end result is that Git will have a good idea of how far branches have diverged. So the import process does lose some patch-trading metadata.
...
-a  
Attempt to auto-register archives at [`http://mirrors.sourcecontrol.net`](http://mirrors.sourcecontrol.net) This is particularly useful with the -D option.
