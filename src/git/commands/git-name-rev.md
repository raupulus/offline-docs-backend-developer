---
title: rev(1) ===============
source_url: https://git-scm.com/doc/git-name-rev
source_repo: https://github.com/git/git.git
source_ref: master
source_commit: 339ab2a8f
source_path: git-name-rev.adoc
technology: git
version: master
license: GPL-2.0
...
DESCRIPTION ----------- Finds symbolic names suitable for human digestion for revisions given in any format parsable by ’git rev-parse’.
