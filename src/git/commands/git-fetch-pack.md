...
source_url: https://git-scm.com/doc/git-fetch-pack
source_repo: https://github.com/git/git.git
source_ref: master
source_commit: 339ab2a8f
source_path: git-fetch-pack.adoc
technology: git
version: master
license: GPL-2.0
...
DESCRIPTION ----------- Usually you would want to use ’git fetch’, which is a higher level wrapper of this command, instead.
...
SEE ALSO -------- [git-fetch](git-fetch.md)
