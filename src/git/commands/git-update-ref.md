...
source_url: https://git-scm.com/doc/git-update-ref
source_repo: https://github.com/git/git.git
source_ref: master
source_commit: 339ab2a8f
source_path: git-update-ref.adoc
technology: git
version: master
license: GPL-2.0
...
DESCRIPTION ----------- Given two arguments, stores the \<new-oid\> in the \<ref\>, possibly dereferencing the symbolic refs. E.g. `git` `update-ref` `HEAD` `<new-oid>` updates the current branch head to the new object.
...
SEE ALSO -------- [git-symbolic-ref](git-symbolic-ref.md)
