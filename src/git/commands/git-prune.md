...
source_url: https://git-scm.com/doc/git-prune
source_repo: https://github.com/git/git.git
source_ref: master
source_commit: 339ab2a8f
source_path: git-prune.adoc
technology: git
version: master
license: GPL-2.0
...
NAME ---- git-prune - Prune all unreachable objects from the object database
...
Note that unreachable, packed objects will remain. If this is not desired, see [git-repack](git-repack.md).
...
[git-fsck](git-fsck.md), [git-gc](git-gc.md), [git-reflog](git-reflog.md)
