...
source_url: https://git-scm.com/doc/git-rev-list
source_repo: https://github.com/git/git.git
source_ref: master
source_commit: 339ab2a8f
source_path: git-rev-list.adoc
technology: git
version: master
license: GPL-2.0
...
NAME ---- git-rev-list - Lists commit objects in reverse chronological order
...
- Format commits with their author and commit message (see also the porcelain [git-log](git-log.md)).

      git rev-list --format=medium HEAD

<!-- -->

- Format commits along with their diffs (see also the porcelain [git-log](git-log.md), which can do this in a single process).
