...
source_url: https://git-scm.com/doc/git-checkout-index
source_repo: https://github.com/git/git.git
source_ref: master
source_commit: 339ab2a8f
source_path: git-checkout-index.adoc
technology: git
version: master
license: GPL-2.0
...
DESCRIPTION ----------- Copies all listed files from the index to the working directory (not overwriting existing files).

OPTIONS ------- -u:: --index:: update stat information for the checked out entries in the index file.
