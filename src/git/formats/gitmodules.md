...
source_url: https://git-scm.com/doc/gitmodules
source_repo: https://github.com/git/git.git
source_ref: master
source_commit: 339ab2a8f
source_path: gitmodules.adoc
technology: git
version: master
license: GPL-2.0
...
NAME ---- gitmodules - Defining submodule properties

SYNOPSIS -------- \$GIT_WORK_TREE/.gitmodules

DESCRIPTION -----------

The `.gitmodules` file, located in the top-level directory of a Git working tree, is a text file with a syntax matching the requirements of [git-config](git-config.md).
...
SEE ALSO -------- [git-submodule](git-submodule.md), [gitsubmodules](gitsubmodules.md), [git-config](git-config.md)
