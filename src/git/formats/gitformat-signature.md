...
source_url: https://git-scm.com/doc/gitformat-signature
source_repo: https://github.com/git/git.git
source_ref: master
source_commit: 339ab2a8f
source_path: gitformat-signature.adoc
technology: git
version: master
license: GPL-2.0
...
NAME ---- gitformat-signature - Git cryptographic signature formats
...
Signatures begin with an "ASCII Armor" header line and end with a tail line, which differ depending on signature type (as selected by `gpg.format`, see [git-config](git-config.md)). These are, for `gpg.format` values:
