...
source_url: https://git-scm.com/doc/gitformat-index
source_repo: https://github.com/git/git.git
source_ref: master
source_commit: 339ab2a8f
source_path: gitformat-index.adoc
technology: git
version: master
license: GPL-2.0
...
NAME ---- gitformat-index - Git index format
...
# Index entry
    ...
    (Version 4) In version 4, the entry path name is prefix-compressed
      ...
      for OFS_DELTA pack entries; see [gitformat-pack](gitformat-pack.md)) is stored, followed
...
- Stat data of \$GIT_COMMON_DIR/info/exclude. See "Index entry" section from ctime field until "file size".
...
- Hash of \$GIT_COMMON_DIR/info/exclude. A null hash means the file does not exist.
