...
source_url: https://git-scm.com/doc/gitignore
source_repo: https://github.com/git/git.git
source_ref: master
source_commit: 339ab2a8f
source_path: gitignore.adoc
technology: git
version: master
license: GPL-2.0
...
SYNOPSIS -------- \$XDG_CONFIG_HOME/git/ignore, \$GIT_COMMON_DIR/info/exclude, .gitignore
...
SEE ALSO -------- [git-rm](git-rm.md), [gitrepository-layout](gitrepository-layout.md), [git-check-ignore](git-check-ignore.md)
