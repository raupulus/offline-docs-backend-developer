...
source_url: https://git-scm.com/doc/gitprotocol-common
source_repo: https://github.com/git/git.git
source_ref: master
source_commit: 339ab2a8f
source_path: gitprotocol-common.adoc
technology: git
version: master
license: GPL-2.0
...
NAME ---- gitprotocol-common - Things common to various protocols
...
1.  They cannot have ASCII control characters (i.e. bytes whose values are lower than \040, or \177 `DEL`), space, tilde `~`, caret `^`, colon `:`, question-mark `?`, asterisk `*`, or open bracket `[` anywhere.

<!-- -->

1.  They cannot end with a slash `/` or a dot `.`.
