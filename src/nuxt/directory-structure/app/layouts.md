---
title: layouts
description: Nuxt provides a layouts framework to extract common UI patterns into
  reusable layouts.
source_repo: nuxt/nuxt
source_ref: main
source_commit: ec5c55e26
source_path: 2.directory-structure/1.app/1.layouts.md
technology: nuxt
version: main
license: MIT
...
You can also set layouts for specific routes using the `appLayout` property in route rules :badge[v4.3]{color="info" size="xs" class="align-middle"}:
