---
title: layers
description: Use the layers/ directory to organize and auto-register local layers
  within your application.
source_repo: nuxt/nuxt
source_ref: main
source_commit: ec5c55e26
source_path: 2.directory-structure/1.layers.md
technology: nuxt
version: main
license: MIT
...
Alternatively, reference the directories in [`extends`](/docs/4.x/api/nuxt-config#extends) (e.g. `extends: ['~~/layers/admin', '~~/layers/base']`) to order them from `nuxt.config` without renaming, with the first entry taking the highest priority.
