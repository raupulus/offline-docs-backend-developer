---
title: Server
description: Build full-stack applications with Nuxt's server framework. You can fetch
  data from your database or another server, create APIs, or even generate static
  server-side content like a sitemap or a RSS feed - all from a single codebase.
source_repo: nuxt/nuxt
source_ref: main
source_commit: ec5c55e26
source_path: 1.getting-started/13.server.md
technology: nuxt
version: main
license: MIT
