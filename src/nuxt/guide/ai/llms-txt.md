---
title: Nuxt LLMs.txt
description: How to get AI tools like Cursor, Windsurf, GitHub Copilot, ChatGPT, and
  Claude to understand Nuxt concepts, APIs, and best practices.
source_repo: nuxt/nuxt
source_ref: main
source_commit: ec5c55e26
source_path: 3.guide/3.ai/2.llms-txt.md
technology: nuxt
version: main
license: MIT
