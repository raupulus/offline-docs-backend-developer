...
description: Nuxt uses Vue.js and adds features such as component auto-imports, file-based
  routing and composables for an SSR-friendly usage.
source_repo: nuxt/nuxt
source_ref: main
source_commit: ec5c55e26
source_path: 3.guide/1.concepts/10.vuejs-development.md
technology: nuxt
version: main
license: MIT
