---
title: TypeScript
description: Nuxt is fully typed and provides helpful shortcuts to ensure you have
  access to accurate type information when you are coding.
source_repo: nuxt/nuxt
source_ref: main
source_commit: ec5c55e26
source_path: 3.guide/1.concepts/8.typescript.md
technology: nuxt
version: main
license: MIT
