...
description: Render individual components on the server only, keeping their JavaScript
  out of your client bundle.
source_repo: nuxt/nuxt
source_ref: main
source_commit: ec5c55e26
source_path: 3.guide/1.concepts/6.server-components.md
technology: nuxt
version: main
license: MIT
