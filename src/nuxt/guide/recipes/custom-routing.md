...
description: In Nuxt, your routing is defined by the structure of your files inside
  the pages directory. However, since it uses vue-router under the hood, Nuxt offers
  you several ways to add custom routes in your project.
source_repo: nuxt/nuxt
source_ref: main
source_commit: ec5c55e26
source_path: 3.guide/5.recipes/1.custom-routing.md
technology: nuxt
version: main
license: MIT
