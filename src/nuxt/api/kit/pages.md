---
title: Pages
description: Nuxt Kit provides a set of utilities to help you create and use pages.
  You can use these utilities to manipulate the pages configuration or to define route
  rules.
source_repo: nuxt/nuxt
source_ref: main
source_commit: ec5c55e26
source_path: 4.api/5.kit/7.pages.md
technology: nuxt
version: main
license: MIT
...
### Typing Custom Page Metadata

You can augment the `NuxtPageMeta` interface to add type-safe custom metadata for pages when using `extendPages` or the `pages:extend` hook:
