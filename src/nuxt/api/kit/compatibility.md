---
title: Compatibility
description: Nuxt Kit provides a set of utilities to help you check the compatibility
  of your modules with different Nuxt versions.
source_repo: nuxt/nuxt
source_ref: main
source_commit: ec5c55e26
source_path: 4.api/5.kit/3.compatibility.md
technology: nuxt
version: main
license: MIT
