---
title: Nitro
description: Nuxt Kit provides a set of utilities to help you work with Nitro. These
  functions allow you to add server handlers, plugins, and prerender routes.
source_repo: nuxt/nuxt
source_ref: main
source_commit: ec5c55e26
source_path: 4.api/5.kit/12.nitro.md
technology: nuxt
version: main
license: MIT
