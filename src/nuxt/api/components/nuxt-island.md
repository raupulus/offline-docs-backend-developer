---
title: <NuxtIsland>
description: Nuxt provides the <NuxtIsland> component to render a non-interactive
  component without any client JS.
source_repo: nuxt/nuxt
source_ref: main
source_commit: ec5c55e26
source_path: 4.api/1.components/8.nuxt-island.md
technology: nuxt
version: main
license: MIT
