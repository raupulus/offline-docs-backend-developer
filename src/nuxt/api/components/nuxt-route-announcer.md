...
description: The <NuxtRouteAnnouncer> component adds a hidden element with the page
  title to announce route changes to assistive technologies.
source_repo: nuxt/nuxt
source_ref: main
source_commit: ec5c55e26
source_path: 4.api/1.components/12.nuxt-route-announcer.md
technology: nuxt
version: main
license: MIT
