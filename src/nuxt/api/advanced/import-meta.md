...
source_path: 4.api/6.advanced/2.import-meta.md
technology: nuxt
version: main
license: MIT
...
`import.meta.envName` :badge[v4.5]{color="info" size="xs" class="align-middle"} | string | The current Nuxt environment name, including custom values passed via `--envName`.
