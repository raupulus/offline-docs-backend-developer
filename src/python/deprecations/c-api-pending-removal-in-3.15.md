...
source_path: deprecations/c-api-pending-removal-in-3.15.txt
technology: python
version: '3.14'
license: PSF-2.0
...
* La función "PyImport_ImportModuleNoBlock()": use
...
* El tipo "Py_UNICODE" y macro "Py_UNICODE_WIDE": use "wchar_t" en su
  lugar.
