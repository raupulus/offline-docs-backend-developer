---
title: 10. Especificación completa de la gramática
source_url: https://docs.python.org/es/3
source_path: reference/grammar.txt
technology: python
version: '3.14'
license: PSF-2.0
...
Grammar/python.gram). La versión aquí omite detalles relacionados con
la generación de código y la recuperación de errores.
