---
title: Tabla de auditoría de eventos
source_url: https://docs.python.org/es/3
source_path: library/audit_events.txt
technology: python
version: '3.14'
license: PSF-2.0
...
Ver "sys.addaudithook()" y "PySys_AddAuditHook()" para informarse en
el manejo de estos eventos.

Esta tabla es generada desde la documentación de CPython, y no debe
guardar eventos lanzados por otras implementaciones. Ver la
documentación de tus especificaciones en tiempo de ejecución para los
eventos lanzados recientemente.
