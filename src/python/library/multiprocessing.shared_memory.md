---
title: '"multiprocessing.shared_memory" --- Shared memory for direct access across
  processes'
source_url: https://docs.python.org/es/3
source_path: library/multiprocessing.shared_memory.txt
technology: python
version: '3.14'
license: PSF-2.0
...
class multiprocessing.shared_memory.SharedMemory(name=None, create=False, size=0, *, track=True)
   ...
   Distinto en la versión 3.13: Added the *track* parameter.
...
class multiprocessing.shared_memory.ShareableList(sequence=None, *, name=None)
   ...
   *name* is the unique name for the requested shared memory, as
   ...
   Para aplicaciones donde eliminar espacios nulos finales es un
   problema, solucionarlo añadiendo siempre incondicionalmente un byte
   extra que no sea 0 al final de dichos valores al almacenar y
   eliminándolo incondicionalmente al recuperarlos.
