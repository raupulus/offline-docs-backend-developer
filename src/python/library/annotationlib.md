---
title: '"annotationlib" --- Functionality for introspecting annotations'
source_url: https://docs.python.org/es/3
source_path: library/annotationlib.txt
technology: python
version: '3.14'
license: PSF-2.0
...
Ver también:
  ...
  **PEP 749** expanded on various aspects of **PEP 649** and
  ...
  Prácticas recomendadas para las anotaciones provides best practices
...
annotationlib.get_annotations(obj, *, globals=None, locals=None, eval_str=False, format=Format.VALUE)
   ...
   * If *obj* is a callable, *globals* defaults to "obj.__globals__",
   ...
   annotations dict of any object. See Prácticas recomendadas para las
   anotaciones for more information on annotations best practices.
