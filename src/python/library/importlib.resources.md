...
source_path: library/importlib.resources.txt
technology: python
version: '3.14'
license: PSF-2.0
...
Nota:
  ...
  sobre el uso de importlib.resources y migración de pkg_resources a
  importlib.resources.
...
importlib.resources.open_binary(anchor, *path_names)
   ...
   Distinto en la versión 3.13: Multiple *path_names* are accepted.
...
importlib.resources.contents(anchor, *path_names)
   ...
   Obsoleto desde la versión 3.11: Prefer "iterdir()" as above, which
