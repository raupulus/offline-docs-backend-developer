---
title: Multiple interpreters in a Python process
source_url: https://docs.python.org/es/3
source_path: c-api/subinterpreters.txt
technology: python
version: '3.14'
license: PSF-2.0
...
typedef PyObject *(*_PyFrameEvalFunction)(PyThreadState *tstate, _PyInterpreterFrame *frame, int throwflag)
   ...
   Distinto en la versión 3.9: The function now takes a *tstate*
   parameter.

   Distinto en la versión 3.11: The *frame* parameter changed from
