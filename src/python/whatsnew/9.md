---
title: Qué hay de nuevo en Python 3.9
source_url: https://docs.python.org/es/3
source_path: whatsnew/3.9.txt
technology: python
version: '3.14'
license: PSF-2.0
...
* *floor division* de operación flotante ahora tiene un mejor
  rendimiento. También se actualiza el mensaje de "ZeroDivisionError"
  para esta operación. (Contribuido por Donghee Na en bpo-39434.)
