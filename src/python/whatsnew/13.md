...
Ver también: **PEP 719** -- Python 3.13 Release Schedule
...
environment variable. For more on interactive mode, see Modo
interactivo.
...
* Remove old buffer protocols deprecated in Python 3.0. Use Protocolo
  búfer instead.
