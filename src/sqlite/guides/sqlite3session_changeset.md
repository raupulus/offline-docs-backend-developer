---
title: Generate A Changeset From A Session Object
source_url: https://www.sqlite.org/session/sqlite3session_changeset.html
source_path: session/sqlite3session_changeset.html
technology: sqlite
version: 3.53.4
license: Blessing
...
The contents of a changeset may be traversed using an iterator created using the [sqlite3changeset_start()](../session/sqlite3changeset_start.md) API. A changeset may be applied to a database with a compatible schema using the [sqlite3changeset_apply()](../session/sqlite3changeset_apply.md) API.
