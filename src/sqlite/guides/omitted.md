---
title: SQL Features That SQLite Does Not Implement
source_url: https://www.sqlite.org/omitted.html
source_path: omitted.html
technology: sqlite
version: 3.53.4
license: Blessing
...
See also the [Quirks, Caveats, and Gotchas](quirks.md) of SQLite.
