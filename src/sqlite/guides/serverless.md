...
source_url: https://www.sqlite.org/serverless.html
source_path: serverless.html
technology: sqlite
version: 3.53.4
license: Blessing
...
There are advantages and disadvantages to being serverless. The main advantage is that there is no separate server process to install, setup, configure, initialize, manage, and troubleshoot. This is one reason why SQLite is a "[zero-configuration](zeroconf.md)" database engine. Programs that use SQLite require no administrative support for setting up the database engine before they are run. Any program that is able to access the disk is able to use an SQLite database.
