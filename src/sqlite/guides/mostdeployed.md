...
source_url: https://www.sqlite.org/mostdeployed.html
source_path: mostdeployed.html
technology: sqlite
version: 3.53.4
license: Blessing
...
Since SQLite is used extensively in every smartphone, and there are more than 4.0 billion (4.0e9) smartphones in active use, each holding hundreds of SQLite database files, it seems likely that there are over one trillion (1e12) SQLite databases in active use.
...
- The original [zlib](http://zlib.net) implementation by Jean-loup Gailly and Mark Adler.
- The original reference implementation for [libpng](http://www.libpng.org)
- Libjpeg from the [Independent JPEG Group](http://ijg.org)
