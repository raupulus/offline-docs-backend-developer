---
title: The COMPLETION() Table-Valued Function
source_url: https://www.sqlite.org/completion.html
source_path: completion.html
technology: sqlite
version: 3.53.4
license: Blessing
...
The COMPLETION extension implements a [table-valued function](vtab.md#tabfunc2) named "completion" that can be used to suggest completions of partially entered words during interactive SQL input. The completion table can be used to help implement tab-completion, for example.
