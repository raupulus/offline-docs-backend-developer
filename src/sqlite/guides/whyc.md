...
source_url: https://www.sqlite.org/whyc.html
source_path: whyc.html
technology: sqlite
version: 3.53.4
license: Blessing
...
An intensively used low-level library like SQLite needs to be fast. (And SQLite is fast, see [Internal Versus External BLOBs](intern-v-extern-blob.md) and [35% Faster Than The Filesystem](fasterthanfs.md) for examples.)
