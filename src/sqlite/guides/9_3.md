---
title: SQLite Release 3.9.3 On 2016-04-01
source_url: https://www.sqlite.org/releaselog/3_9_3.html
source_path: releaselog/3_9_3.html
technology: sqlite
version: 3.53.4
license: Blessing
...
1.  Backport a [simple query planner optimization](https://sqlite.org/src/info/c648539b52ca28c0) that allows the IS operator to drive an index on a LEFT OUTER JOIN. No other changes from the [version 3.9.2](../releaselog/3_9_2.md) baseline.
