...
source_url: https://www.sqlite.org/consortium.html
source_path: consortium.html
technology: sqlite
version: 3.53.4
license: Blessing
...
- We will be happy to [recognize consortium members](index.md#sponsors) on the SQLite website with a logo and/or a brief acknowledgement of their contribution to the project. This is an opportunity for companies to build good will by demonstrating that they are giving back to the community. Or, members can remain anonymous.

## How To Become A Consortium Member

Membership in the SQLite Consortium is via contract with [Hipp, Wyrick & Company, Inc.](https://www.hwaci.com/). Send email to <drh@sqlite.org> or phone +1.704.948.4565 during US east-coast business hours for additional information.
