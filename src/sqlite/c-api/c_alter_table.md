---
title: Authorizer Action Codes
source_url: https://www.sqlite.org/c3ref/c_alter_table.html
source_path: c3ref/c_alter_table.html
technology: sqlite
version: 3.53.4
license: Blessing
...
The [sqlite3_set_authorizer()](../c3ref/set_authorizer.md) interface registers a callback function that is invoked to authorize certain SQL statement actions. The second parameter to the callback is an integer code that specifies what action is being authorized. These are the integer action codes that the authorizer callback may be passed.
