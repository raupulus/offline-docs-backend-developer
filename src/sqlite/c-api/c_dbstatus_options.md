---
title: Status Parameters for database connections
source_url: https://www.sqlite.org/c3ref/c_dbstatus_options.html
source_path: c3ref/c_dbstatus_options.html
technology: sqlite
version: 3.53.4
license: Blessing
...
These constants are the available integer "verbs" that can be passed as the second argument to the [sqlite3_db_status()](../c3ref/db_status.md) interface.

New verbs may be added in future releases of SQLite. Existing verbs might be discontinued. Applications should check the return code from [sqlite3_db_status()](../c3ref/db_status.md) to make sure that the call worked. The [sqlite3_db_status()](../c3ref/db_status.md) interface will return a non-zero error code if a discontinued or unsupported verb is invoked.
