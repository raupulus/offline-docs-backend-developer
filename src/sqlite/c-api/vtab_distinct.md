---
title: Determine if a virtual table query is DISTINCT
source_url: https://www.sqlite.org/c3ref/vtab_distinct.html
source_path: c3ref/vtab_distinct.html
technology: sqlite
version: 3.53.4
license: Blessing
...
1.  If the sqlite3_vtab_distinct() interface returns 0, that means that the query planner needs the virtual table to return all rows in the sort order defined by the "nOrderBy" and "aOrderBy" fields of the [sqlite3_index_info](../c3ref/index_info.md) object. This is the default expectation. If the virtual table outputs all rows in sorted order, then it is always safe for the xBestIndex method to set the "orderByConsumed" flag, regardless of the return value from sqlite3_vtab_distinct().
...
If a virtual table implementation is unable to meet the requirements specified above, then it must not set the "orderByConsumed" flag in the [sqlite3_index_info](../c3ref/index_info.md) object or an incorrect answer may result.
