---
title: Ejemplos
source_url: https://www.php.net/manual/es/event.examples.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/event/examples.xml
technology: php
version: master
license: CC-BY-3.0
...
Cliente HTTP utilizando una resolución DNS asíncrona
...
Uso de un bucle libevent para realizar las peticiones de la extensión \`eio'
...
Escucha de una conexión basada en un socket de dominio Unix
