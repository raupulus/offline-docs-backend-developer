...
description: Obtener información del protocolo MySQL
source_url: https://www.php.net/manual/es/function.mysql-get-proto-info.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/mysql/functions/mysql-get-proto-info.xml
technology: php
version: master
license: CC-BY-3.0
...
Ejemplo de `mysql_get_proto_info`
