...
description: Devuelve si incluir o no el término de límite superior en el conjunto
  de resultados
source_url: https://www.php.net/manual/es/solrquery.gettermsincludeupperbound.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/solr/solrquery/gettermsincludeupperbound.xml
technology: php
version: master
license: CC-BY-3.0
