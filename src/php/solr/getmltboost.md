...
description: Devuelve si la consulta será impulsada (boost) o no mediante la relevancia
  del térmido de interés
source_url: https://www.php.net/manual/es/solrquery.getmltboost.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/solr/solrquery/getmltboost.xml
technology: php
version: master
license: CC-BY-3.0
