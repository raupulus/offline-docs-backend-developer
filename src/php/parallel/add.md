...
source_url: https://www.php.net/manual/es/parallel-events-input.add.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/parallel/parallel/input/add.xml
technology: php
version: master
license: CC-BY-3.0
...
> [!WARNING]
> Lanza una `parallel\Events\Input\Error\IllegalValue` si el valor es ilegal (`object`, `null`).
