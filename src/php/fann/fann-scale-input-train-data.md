---
title: fann_scale_input_train_data
description: Escala las entradas de los datos de entrenamiento al rango especificado
source_url: https://www.php.net/manual/es/function.fann-scale-input-train-data.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/fann/functions/fann-scale-input-train-data.xml
technology: php
version: master
license: CC-BY-3.0
