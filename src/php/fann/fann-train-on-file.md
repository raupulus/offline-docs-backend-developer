...
description: Entrena un conjunto de datos completo leído desde un fichero, por un
  período de tiempo
source_url: https://www.php.net/manual/es/function.fann-train-on-file.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/fann/functions/fann-train-on-file.xml
technology: php
version: master
license: CC-BY-3.0
