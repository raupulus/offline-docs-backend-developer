---
title: fann_set_scaling_params
description: Calcular los parámetros de escala de entrada y salida para un uso futuro
  basados en datos de entrenamiento
source_url: https://www.php.net/manual/es/function.fann-set-scaling-params.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/fann/functions/fann-set-scaling-params.xml
technology: php
version: master
license: CC-BY-3.0
...
Calcular los parámetros de escala de entrada y salida para un uso futuro basados en datos de entrenamiento
