---
title: ibase_commit
description: Valida una transacción iBase
source_url: https://www.php.net/manual/es/function.ibase-commit.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/ibase/functions/ibase-commit.xml
technology: php
version: master
license: CC-BY-3.0
