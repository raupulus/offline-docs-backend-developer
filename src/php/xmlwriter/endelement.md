...
description: Finaliza el actual elemento
source_url: https://www.php.net/manual/es/xmlwriter.endelement.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/xmlwriter/xmlwriter/endelement.xml
technology: php
version: master
license: CC-BY-3.0
