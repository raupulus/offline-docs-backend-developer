...
description: Escribe un texto sin formato del XML
source_url: https://www.php.net/manual/es/xmlwriter.writeraw.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/xmlwriter/xmlwriter/writeraw.xml
technology: php
version: master
license: CC-BY-3.0
