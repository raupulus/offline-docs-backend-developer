...
description: Escribe un atributo de un espacio de nombres
source_url: https://www.php.net/manual/es/xmlwriter.writeattributens.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/xmlwriter/xmlwriter/writeattributens.xml
technology: php
version: master
license: CC-BY-3.0
...
`prefix`  
El prefijo del espacio de nombres. Si el parámetro `prefix` vale `null`, el espacio de nombres será omitido.
