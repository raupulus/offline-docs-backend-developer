...
source_url: https://www.php.net/manual/es/migration73.constants.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: appendices/migration73/constants.xml
technology: php
version: master
license: CC-BY-3.0
...
translation_revision: 7034bb7f2
order: 600
---
...
- `CURL_VERSION_ALTSVC` (a partir de PHP 7.3.6)
...
- `CURL_VERSION_CURLDEBUG` (a partir de PHP 7.3.6)
...
- `CURL_VERSION_PSL` (a partir de PHP 7.3.6)
