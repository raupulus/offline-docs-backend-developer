...
description: Termina la suscripción a un buzón de correo
source_url: https://www.php.net/manual/es/function.imap-unsubscribe.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/imap/functions/imap-unsubscribe.xml
technology: php
version: master
license: CC-BY-3.0
...
Termina la suscripción a un buzón de correo
