...
source_url: https://www.php.net/manual/es/ds-deque.join.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/ds/ds/deque/join.xml
technology: php
version: master
license: CC-BY-3.0
...
Ejemplo de `Ds\Deque::join` utilizando un string separador
...
Ejemplo de `Ds\Deque::join` sin string separador
