...
source_url: https://www.php.net/manual/es/ds-vector.sorted.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/ds/ds/vector/sorted.xml
technology: php
version: master
license: CC-BY-3.0
...
Ejemplo de `Ds\Vector::sorted` utilizando un comparador
