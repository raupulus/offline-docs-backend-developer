...
description: Este método de fábrica crea un conjunto a partir de un fichero
source_url: https://www.php.net/manual/es/quickhashintset.loadfromfile.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/quickhash/quickhashintset/loadfromfile.xml
technology: php
version: master
license: CC-BY-3.0
...
Este método de fábrica crea un conjunto a partir de un fichero
...
Ejemplo de `QuickHashIntSet::loadFromFile`
