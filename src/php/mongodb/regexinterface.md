---
title: La interfaz MongoDB\BSON\RegexInterface
source_url: https://www.php.net/manual/es/class.mongodb-bson-regexinterface.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/mongodb/bson/regexinterface.xml
technology: php
version: master
license: CC-BY-3.0
...
Esta interfaz es implementada por `MongoDB\BSON\Regex` para ser utilizada como tipo de argumento, de retorno o de propiedad en las clases de usuario.
