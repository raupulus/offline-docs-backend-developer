---
title: MongoDB\Driver\BulkWriteCommand::updateMany
description: Añade una operación updateMany
source_url: https://www.php.net/manual/es/mongodb-driver-bulkwritecommand.updatemany.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/mongodb/mongodb/driver/bulkwritecommand/updatemany.xml
technology: php
version: master
license: CC-BY-3.0
...
Añade una operación updateMany

## Descripción

```php
public MongoDB\Driver\BulkWriteCommand::updateMany(string $namespace, array $filter, array $update, [array $options]): void
```php

Añade una operación updateMany a la `MongoDB\Driver\BulkWriteCommand`. Todos los documentos que coincidan con `filter` en la colección identificada por `namespace` serán actualizados.
...
<td>Si <code>filter</code> no coincide con un documento existente, inserta un <em>único</em> documento. El documento se creará aplicando los operadores en <code>update</code> a cualquier valor de campo en <code>filter</code>.</td>
...
Ejemplo de `MongoDB\Driver\BulkWriteCommand::updateMany`
