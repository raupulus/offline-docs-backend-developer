...
description: Devuelve el nombre de host del servidor
source_url: https://www.php.net/manual/es/mongodb-driver-monitoring-serverheartbeatsucceededevent.gethost.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/mongodb/mongodb/driver/monitoring/serverheartbeatsucceededevent/gethost.xml
technology: php
version: master
license: CC-BY-3.0
