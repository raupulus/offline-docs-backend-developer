...
description: Elimina un documento de clave
source_url: https://www.php.net/manual/es/mongodb-driver-clientencryption.deletekey.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/mongodb/mongodb/driver/clientencryption/deletekey.xml
technology: php
version: master
license: CC-BY-3.0
...
Elimina el documento de clave con el UUID `keyId` dado de la colección de almacén de claves.
...
Devuelve el resultado de la operación interna `deleteOne` en la colección de almacén de claves.
