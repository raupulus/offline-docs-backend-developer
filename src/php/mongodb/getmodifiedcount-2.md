...
description: Devuelve el número de documentos existentes actualizados
source_url: https://www.php.net/manual/es/mongodb-driver-writeresult.getmodifiedcount.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/mongodb/mongodb/driver/writeresult/getmodifiedcount.xml
technology: php
version: master
license: CC-BY-3.0
...
Ejemplo con `MongoDB\Driver\WriteResult::getModifiedCount`
