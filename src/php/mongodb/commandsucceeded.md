...
description: Método de notificación para un comando exitoso
source_url: https://www.php.net/manual/es/mongodb-driver-monitoring-commandsubscriber.commandsucceeded.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/mongodb/mongodb/driver/monitoring/commandsubscriber/commandsucceeded.xml
technology: php
version: master
license: CC-BY-3.0
...
Método de notificación para un comando exitoso
...
Si el observador está registrado, este método es llamado cuando un comando tiene éxito.
