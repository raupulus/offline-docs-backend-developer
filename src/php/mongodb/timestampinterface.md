---
title: La interfaz MongoDB\BSON\TimestampInterface
source_url: https://www.php.net/manual/es/class.mongodb-bson-timestampinterface.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/mongodb/bson/timestampinterface.xml
technology: php
version: master
license: CC-BY-3.0
...
Esta interfaz es implementada por `MongoDB\BSON\Timestamp` para ser utilizada como un parámetro, retorno o tipo de propiedad en clases de usuario.
