...
description: Devuelve el mensaje de error del WriteConcernError
source_url: https://www.php.net/manual/es/mongodb-driver-writeconcernerror.getmessage.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/mongodb/mongodb/driver/writeconcernerror/getmessage.xml
technology: php
version: master
license: CC-BY-3.0
...
Ejemplo con `MongoDB\Driver\WriteConcernError::getMessage`
