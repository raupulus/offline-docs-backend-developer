...
source_url: https://www.php.net/manual/es/mongodb-bson-symbol.jsonserialize.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/mongodb/bson/symbol/jsonserialize.xml
technology: php
version: master
license: CC-BY-3.0
...
Devuelve datos que pueden ser serializados por `json_encode` para producir una representación JSON extendida del `MongoDB\BSON\Symbol`.
