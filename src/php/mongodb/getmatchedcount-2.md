...
description: Devuelve el número de documentos seleccionados para la actualización
source_url: https://www.php.net/manual/es/mongodb-driver-writeresult.getmatchedcount.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/mongodb/mongodb/driver/writeresult/getmatchedcount.xml
technology: php
version: master
license: CC-BY-3.0
...
Ejemplo con `MongoDB\Driver\WriteResult::getMatchedCount`
