...
description: Dar de baja una suscripción existente
source_url: https://www.php.net/manual/es/stomp.unsubscribe.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/stomp/stomp/unsubscribe.xml
technology: php
version: master
license: CC-BY-3.0
