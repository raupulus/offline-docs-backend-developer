---
title: mb_trim
description: Elimina los espacios (u otros caracteres) del inicio y final de un string
source_url: https://www.php.net/manual/es/function.mb-trim.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/mbstring/functions/mb-trim.xml
technology: php
version: master
license: CC-BY-3.0
...
Realiza una operación `trim` segura para multi-octetos, y devuelve un string con los espacios eliminados del inicio y final de `string`. Sin el segundo parámetro, `mb_trim` eliminará los siguientes caracteres:
