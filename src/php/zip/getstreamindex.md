...
description: Recupera un manejador de archivo para la entrada definida por su índice
  (solo lectura)
source_url: https://www.php.net/manual/es/ziparchive.getstreamindex.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/zip/ziparchive/getstreamindex.xml
technology: php
version: master
license: CC-BY-3.0
...
Recupera un manejador de archivo para la entrada definida por su índice (solo lectura)

## Descripción

```php
public ZipArchive::getStreamIndex(int $index, [int $flags]): resource
```php
