---
title: closedir
description: Cerrar el gestor de directorio
source_url: https://www.php.net/manual/es/function.closedir.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/dir/functions/closedir.xml
technology: php
version: master
license: CC-BY-3.0
...
Cierra el flujo de directorio indicado por `dir_handle`.
