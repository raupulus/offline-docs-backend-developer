---
title: trader_midprice
description: Precio de punto medio sobre un periodo
source_url: https://www.php.net/manual/es/function.trader-midprice.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/trader/functions/trader-midprice.xml
technology: php
version: master
license: CC-BY-3.0
...
Precio de punto medio sobre un periodo
