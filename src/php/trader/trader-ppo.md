---
title: trader_ppo
description: Oscilador de precio porcentual
source_url: https://www.php.net/manual/es/function.trader-ppo.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/trader/functions/trader-ppo.xml
technology: php
version: master
license: CC-BY-3.0
...
Oscilador de precio porcentual
