---
title: trader_adxr
description: Tasación del índice de movimiento direccional medio
source_url: https://www.php.net/manual/es/function.trader-adxr.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/trader/functions/trader-adxr.xml
technology: php
version: master
license: CC-BY-3.0
...
Tasación del índice de movimiento direccional medio
