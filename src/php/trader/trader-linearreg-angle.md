---
title: trader_linearreg_angle
description: Ángulo de regresión lineal
source_url: https://www.php.net/manual/es/function.trader-linearreg-angle.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/trader/functions/trader-linearreg-angle.xml
technology: php
version: master
license: CC-BY-3.0
