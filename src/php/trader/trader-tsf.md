---
title: trader_tsf
description: Previsión de series de tiempo
source_url: https://www.php.net/manual/es/function.trader-tsf.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/trader/functions/trader-tsf.xml
technology: php
version: master
license: CC-BY-3.0
