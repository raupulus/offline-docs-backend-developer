...
description: Calcula la intersección de dos arrays con pruebas sobre el índice, compara
  los datos utilizando una función de retrollamada
source_url: https://www.php.net/manual/es/function.array-uintersect-assoc.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/array/functions/array-uintersect-assoc.xml
technology: php
version: master
license: CC-BY-3.0
...
Ejemplo con `array_uintersect_assoc`
