...
source_url: https://www.php.net/manual/es/function.snmp3-set.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/snmp/functions/snmp3-set.xml
technology: php
version: master
license: CC-BY-3.0
...
```php
snmp3_set(string $hostname, string $security_name, string $security_level, string $auth_protocol, string $auth_passphrase, string $privacy_protocol, string $privacy_passphrase, array $object_id, array $type, array $value, [int $timeout], [int $retries]): bool
```php
...
Ejemplo con `snmp3_set` para configurar el identificador del objeto SNMP BITS
