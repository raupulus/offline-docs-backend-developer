...
description: Devuelve el punto primario verde de la cromaticidad
source_url: https://www.php.net/manual/es/gmagick.getimagegreenprimary.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/gmagick/gmagick/getimagegreenprimary.xml
technology: php
version: master
license: CC-BY-3.0
