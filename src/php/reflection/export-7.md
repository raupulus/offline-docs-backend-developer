...
source_url: https://www.php.net/manual/es/reflectionobject.export.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/reflection/reflectionobject/export.xml
technology: php
version: master
license: CC-BY-3.0
...
```php
public static ReflectionObject::export(string $argumento, [bool $return]): string
```php
