...
source_url: https://www.php.net/manual/es/reflectionproperty.getattributes.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/reflection/reflectionproperty/getattributes.xml
technology: php
version: master
license: CC-BY-3.0
...
```php
public ReflectionProperty::getAttributes([string $name], [int $flags]): array
```php
