...
description: Exporta
source_url: https://www.php.net/manual/es/reflection.export.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/reflection/reflection/export.xml
technology: php
version: master
license: CC-BY-3.0
...
> [!WARNING]
> Esta función está *OBSOLETA* a partir de PHP 7.4.0. Depender de esta función está altamente desaconsejado.

## Descripción

```php
public static Reflection::export(Reflector $reflector, [bool $return]): string
```php
