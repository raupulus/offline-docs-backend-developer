---
title: Parle\RParser::trace
description: Rastrea la operación del analizador
source_url: https://www.php.net/manual/es/parle-rparser.trace.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/parle/parle/rparser/trace.xml
technology: php
version: master
license: CC-BY-3.0
...
Devuelve un `string` con la información de rastreo.
