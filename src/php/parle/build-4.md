...
description: Finaliza las reglas de gramática
source_url: https://www.php.net/manual/es/parle-rparser.build.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/parle/parle/rparser/build.xml
technology: php
version: master
license: CC-BY-3.0
