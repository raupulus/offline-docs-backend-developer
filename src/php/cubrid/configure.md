---
title: Instalación
source_url: https://www.php.net/manual/es/cubrid.installation.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/cubrid/configure.xml
technology: php
version: master
license: CC-BY-3.0
...
Para obtener información sobre la instalación manual en Linux y en Windows, por favor, lea el fichero `build-guide.html` incluido en el paquete.
