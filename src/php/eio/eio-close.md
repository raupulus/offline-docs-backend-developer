---
title: eio_close
description: Cerrar un fichero
source_url: https://www.php.net/manual/es/function.eio-close.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/eio/functions/eio-close.xml
technology: php
version: master
license: CC-BY-3.0
...
```php
eio_close(mixed $fd, [int $pri], [callable $callback], [mixed $data]): resource
```php

`eio_close` cierra el fichero especificado por `fd`.
...
`eio_close` devuelve un recurso de petición en caso de éxito, o `false` si ocurre un error.
