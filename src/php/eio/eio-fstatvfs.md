...
source_url: https://www.php.net/manual/es/function.eio-fstatvfs.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/eio/functions/eio-fstatvfs.xml
technology: php
version: master
license: CC-BY-3.0
...
`eio_fstatvfs` devuelve las estadísticas del sistema de ficheros en el parámetro `result` de `callback`.
...
`eio_fstatvfs` devuelve un recurso de petición en caso de éxito, o `false` si ocurre un error.
