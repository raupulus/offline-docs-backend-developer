---
title: eio_ftruncate
description: Truncar un fichero
source_url: https://www.php.net/manual/es/function.eio-ftruncate.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/eio/functions/eio-ftruncate.xml
technology: php
version: master
license: CC-BY-3.0
...
```php
eio_ftruncate(mixed $fd, [int $offset], [int $pri], [callable $callback], [mixed $data]): resource
```php

`eio_ftruncate` hace que un fichero regular referenciado por el descriptor de fichero `fd` sea truncado a exactamente `length` bytes.
...
`eio_ftruncate` devuelve un recurso de petición en caso de éxito, o `false` si ocurre un error.
