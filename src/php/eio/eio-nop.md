---
title: eio_nop
description: No hace nada, sólo recorre el ciclo de peticiones entero
source_url: https://www.php.net/manual/es/function.eio-nop.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/eio/functions/eio-nop.xml
technology: php
version: master
license: CC-BY-3.0
...
No hace nada, sólo recorre el ciclo de peticiones entero

## Descripción

```php
eio_nop([int $pri], [callable $callback], [mixed $data]): resource
```php

`eio_nop` no hace nada, sólo recorre el ciclo de peticiones entero. Podría ser util al depurar.
...
`eio_nop` devuelve un recurso de petición en caso de éxito, o `false` si ocurre un error.
