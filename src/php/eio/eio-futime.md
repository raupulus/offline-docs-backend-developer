---
title: eio_futime
description: Cambiar los momentos de último y acceso y modificación de un fichero
source_url: https://www.php.net/manual/es/function.eio-futime.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/eio/functions/eio-futime.xml
technology: php
version: master
license: CC-BY-3.0
...
Cambiar los momentos de último y acceso y modificación de un fichero

## Descripción

```php
eio_futime(mixed $fd, float $atime, float $mtime, [int $pri], [callable $callback], [mixed $data]): resource
```php

`eio_futime` cambia los momentos de último acceso y modificación de un fichero.
...
`eio_futime` devuelve un recurso de petición en caso de éxito, o `false` si ocurre un error.
