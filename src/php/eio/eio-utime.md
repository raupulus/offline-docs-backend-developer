...
source_url: https://www.php.net/manual/es/function.eio-utime.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/eio/functions/eio-utime.xml
technology: php
version: master
license: CC-BY-3.0
...
```php
eio_utime(string $path, float $atime, float $mtime, [int $pri], [callable $callback], [mixed $data]): resource
```php
...
`eio_utime` devuelve un recurso de petición en caso de éxito, o `false` si ocurre un error.
