---
title: eio_fdatasync
description: Sincronizar el estado de ficheros que están en memoria con un dispositivo
  de almacenamiento
source_url: https://www.php.net/manual/es/function.eio-fdatasync.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/eio/functions/eio-fdatasync.xml
technology: php
version: master
license: CC-BY-3.0
...
Sincronizar el estado de ficheros que están en memoria con un dispositivo de almacenamiento

## Descripción

```php
eio_fdatasync(mixed $fd, [int $pri], [callable $callback], [mixed $data]): resource
```php
...
`eio_fdatasync` devuelve un recurso de petición en caso de éxito, o `false` si ocurre un error.
