---
title: Zookeeper::__construct
description: Crea un manejador para comunicarse con Zookeeper
source_url: https://www.php.net/manual/es/zookeeper.construct.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/zookeeper/zookeeper/construct.xml
technology: php
version: master
license: CC-BY-3.0
...
```php
public Zookeeper::__construct([string $host], [callable $watcher_cb], [int $recv_timeout])
```php
