...
source_url: https://www.php.net/manual/es/function.fprintf.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/strings/functions/fprintf.xml
technology: php
version: master
license: CC-BY-3.0
...
Escribe la cadena producida con el formato `format` en el flujo representado por `stream`.
...
`fprintf`: Enteros con ceros iniciales
...
`printf`, `sprintf`, `vprintf`, `vsprintf`, `vfprintf`, `sscanf`, `fscanf`, `number_format`, `date`
