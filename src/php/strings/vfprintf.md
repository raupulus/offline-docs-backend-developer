---
title: vfprintf
description: Escribe una cadena formateada en un flujo
source_url: https://www.php.net/manual/es/function.vfprintf.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/strings/functions/vfprintf.xml
technology: php
version: master
license: CC-BY-3.0
...
Escribe una cadena formateada en un flujo
...
Escribe una cadena producida de acuerdo con el argumento `format` en el flujo `stream`.

Actúa de la misma manera que `fprintf` excepto que `vfprintf` acepta un array de argumentos, en lugar de un número variable de argumentos.
...
`vfprintf`: cero como caracteres de espaciado
