...
description: Establece el color de borde de la imagen
source_url: https://www.php.net/manual/es/imagick.setimagebordercolor.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/imagick/imagick/setimagebordercolor.xml
technology: php
version: master
license: CC-BY-3.0
