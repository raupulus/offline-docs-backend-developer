...
description: Tuerce el sistema de coordenadas actual en la dirección vertical
source_url: https://www.php.net/manual/es/imagickdraw.skewy.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/imagick/imagickdraw/skewy.xml
technology: php
version: master
license: CC-BY-3.0
