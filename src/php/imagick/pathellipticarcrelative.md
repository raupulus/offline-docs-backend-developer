...
description: Dibuja un arco de elipse, en coordenadas relativas
source_url: https://www.php.net/manual/es/imagickdraw.pathellipticarcrelative.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/imagick/imagickdraw/pathellipticarcrelative.xml
technology: php
version: master
license: CC-BY-3.0
...
Dibuja un arco de elipse, en coordenadas relativas

## Descripción

```php
public ImagickDraw::pathEllipticArcRelative(float $rx, float $ry, float $x_axis_rotation, bool $large_arc, bool $sweep, float $x, float $y): bool
```php
