---
title: svn_fs_props_changed
description: Devuelve verdadero si las propiedades son diferentes, falso en caso contrario
source_url: https://www.php.net/manual/es/function.svn-fs-props-changed.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/svn/functions/svn-fs-props-changed.xml
technology: php
version: master
license: CC-BY-3.0
