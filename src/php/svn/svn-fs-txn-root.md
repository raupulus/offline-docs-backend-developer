---
title: svn_fs_txn_root
description: Crea y retorna una transacción 'root'
source_url: https://www.php.net/manual/es/function.svn-fs-txn-root.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/svn/functions/svn-fs-txn-root.xml
technology: php
version: master
license: CC-BY-3.0
