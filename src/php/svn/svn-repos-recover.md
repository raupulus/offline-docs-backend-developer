---
title: svn_repos_recover
description: Ejecuta los procesos de recuperación en el repositorio localizado en
  un path determinado
source_url: https://www.php.net/manual/es/function.svn-repos-recover.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/svn/functions/svn-repos-recover.xml
technology: php
version: master
license: CC-BY-3.0
