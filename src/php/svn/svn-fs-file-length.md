---
title: svn_fs_file_length
description: Devuelve la longitud de un fichero para una versión dada de sistema de
  ficheros
source_url: https://www.php.net/manual/es/function.svn-fs-file-length.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/svn/functions/svn-fs-file-length.xml
technology: php
version: master
license: CC-BY-3.0
