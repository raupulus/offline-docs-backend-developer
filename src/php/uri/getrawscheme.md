---
title: Uri\Rfc3986\Uri::getRawScheme
description: Recupera el componente de esquema sin procesar
source_url: https://www.php.net/manual/es/uri-rfc3986-uri.getrawscheme.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/uri/uri/rfc3986/uri/getrawscheme.xml
technology: php
version: master
license: CC-BY-3.0
...
```php
public Uri\Rfc3986\Uri::getRawScheme(): string
```php
