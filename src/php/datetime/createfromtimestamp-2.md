---
title: DateTimeImmutable::createFromTimestamp
description: Crea una instancia a partir de una marca de tiempo Unix
source_url: https://www.php.net/manual/es/datetimeimmutable.createfromtimestamp.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/datetime/datetimeimmutable/createfromtimestamp.xml
technology: php
version: master
license: CC-BY-3.0
...
```php
public static DateTimeImmutable::createFromTimestamp(int $timestamp): static
```php
...
Ejemplo de DateTimeImmutable::createFromTimestamp
