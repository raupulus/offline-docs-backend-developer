---
title: fdf_get_status
description: Lee el valor de la clave /STATUS
source_url: https://www.php.net/manual/es/function.fdf-get-status.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/fdf/functions/fdf-get-status.xml
technology: php
version: master
license: CC-BY-3.0
