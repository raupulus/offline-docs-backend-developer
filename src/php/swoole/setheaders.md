...
source_url: https://www.php.net/manual/es/swoole-coroutine-http-client.setheaders.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/swoole/swoole/coroutine/http/client/setheaders.xml
technology: php
version: master
license: CC-BY-3.0
