---
title: DOMNode::__wakeup
description: Prohíbe la deserialización a menos que los métodos de deserialización
  estén implementados en una subclase
source_url: https://www.php.net/manual/es/domnode.wakeup.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/dom/domnode/wakeup.xml
technology: php
version: master
license: CC-BY-3.0
