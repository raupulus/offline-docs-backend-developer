...
description: Añade nodos antes del nodo
source_url: https://www.php.net/manual/es/domchildnode.before.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/dom/domchildnode/before.xml
technology: php
version: master
license: CC-BY-3.0
...
```php
public DOMChildNode::before(DOMNode ...$nodes): void
```php
...
`nodes`  
Nodos a añadir antes del nodo. Las cadenas de caracteres son automáticamente convertidas en nodos de texto.
...
DOMChildNode::after, DOMChildNode::remove, DOMChildNode::replaceWith
