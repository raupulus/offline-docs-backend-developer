---
title: Win32Service\RightInfo::isGrantAccess
description: Devuelve true si el RightInfo se refiere al acceso al recurso
source_url: https://www.php.net/manual/es/win32service-rightinfo.is-grant-access.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/win32service/rightinfo/is-grant-access.xml
technology: php
version: master
license: CC-BY-3.0
...
Devuelve true si el RightInfo se refiere al acceso al recurso

## Descripción

```php
final public Win32Service\RightInfo::isGrantAccess(): bool
```php
