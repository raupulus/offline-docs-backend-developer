...
source_url: https://www.php.net/manual/es/mysql-xdevapi-result.getwarnings.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/mysql_xdevapi/mysql_xdevapi/result/getwarnings.xml
technology: php
version: master
license: CC-BY-3.0
...
Un array de objetos Warning de la última operación. Cada objeto define un mensaje de error, un nivel de error y un código de error. Se devuelve un array vacío si no hay errores.
