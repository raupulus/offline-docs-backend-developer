...
source_url: https://www.php.net/manual/es/mysql-xdevapi-rowresult.getwarningscount.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/mysql_xdevapi/mysql_xdevapi/rowresult/getwarningscount.xml
technology: php
version: master
license: CC-BY-3.0
