---
title: sodium_crypto_box_seed_keypair
description: Deriva de manera determinista el par de claves a partir de una sola clave
source_url: https://www.php.net/manual/es/function.sodium-crypto-box-seed-keypair.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/sodium/functions/sodium-crypto-box-seed-keypair.xml
technology: php
version: master
license: CC-BY-3.0
...
```php
#[\SensitiveParameter] sodium_crypto_box_seed_keypair(string $seed): string
```php
