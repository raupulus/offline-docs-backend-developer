---
title: sodium_crypto_core_ristretto255_add
description: Añade un elemento
source_url: https://www.php.net/manual/es/function.sodium-crypto-core-ristretto255-add.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/sodium/functions/sodium-crypto-core-ristretto255-add.xml
technology: php
version: master
license: CC-BY-3.0
...
Añade un elemento `q` a `p`. Disponible a partir de libsodium 1.0.18.
...
Ejemplo de `sodium_crypto_core_ristretto255_add`
