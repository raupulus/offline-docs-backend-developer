...
description: Ordenar con una función de comparación definida por el usuario y mantener
  la asociación del índice
source_url: https://www.php.net/manual/es/arrayiterator.uasort.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/spl/arrayiterator/uasort.xml
technology: php
version: master
license: CC-BY-3.0
...
Ordenar con una función de comparación definida por el usuario y mantener la asociación del índice
...
Este método ordena los elementos de tal manera que los índices mantienen su correlación con los valores a los que están asociados, utilizando una función de comparación definida por el usuario.
