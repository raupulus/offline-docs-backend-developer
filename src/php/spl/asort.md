...
description: Ordena las entradas por los valores
source_url: https://www.php.net/manual/es/arrayiterator.asort.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/spl/arrayiterator/asort.xml
technology: php
version: master
license: CC-BY-3.0
...
```php
public ArrayIterator::asort([int $flags]): true
```php
