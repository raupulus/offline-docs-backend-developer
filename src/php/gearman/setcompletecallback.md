...
description: Define una función a llamar una vez finalizada la tarea
source_url: https://www.php.net/manual/es/gearmanclient.setcompletecallback.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/gearman/gearmanclient/setcompletecallback.xml
technology: php
version: master
license: CC-BY-3.0
