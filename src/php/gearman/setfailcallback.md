...
description: Define una función de retrollamada a llamar cuando un trabajo falla
source_url: https://www.php.net/manual/es/gearmanclient.setfailcallback.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/gearman/gearmanclient/setfailcallback.xml
technology: php
version: master
license: CC-BY-3.0
