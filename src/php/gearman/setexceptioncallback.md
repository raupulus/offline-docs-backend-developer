...
description: Define una función de retrollamada para las excepciones emitidas por
  el agente
source_url: https://www.php.net/manual/es/gearmanclient.setexceptioncallback.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/gearman/gearmanclient/setexceptioncallback.xml
technology: php
version: master
license: CC-BY-3.0
