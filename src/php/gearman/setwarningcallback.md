...
description: Define una función de retrollamada al emitir una alerta desde el agente
source_url: https://www.php.net/manual/es/gearmanclient.setwarningcallback.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/gearman/gearmanclient/setwarningcallback.xml
technology: php
version: master
license: CC-BY-3.0
