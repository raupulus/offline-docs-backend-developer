---
title: radius_put_vendor_addr
description: Asocia una dirección IP específica a un proveedor
source_url: https://www.php.net/manual/es/function.radius-put-vendor-addr.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/radius/functions/radius-put-vendor-addr.xml
technology: php
version: master
license: CC-BY-3.0
...
Asocia una dirección IP específica a un proveedor
...
| Versión           | Descripción                                      |
|-------------------|--------------------------------------------------|
| PECL radius 1.3.0 | Se han añadido los parámetros `options` y `tag`. |
