---
title: variant_pow
description: Devuelve el resultado de la función potencia con dos variantes
source_url: https://www.php.net/manual/es/function.variant-pow.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/com/functions/variant-pow.xml
technology: php
version: master
license: CC-BY-3.0
...
Devuelve el resultado de la función potencia con dos variantes
...
Devuelve el resultado de `left` elevado a la potencia `right`.
