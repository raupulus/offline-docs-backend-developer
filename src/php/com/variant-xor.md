---
title: variant_xor
description: Ejecuta una exclusión lógica sobre dos variantes
source_url: https://www.php.net/manual/es/function.variant-xor.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/com/functions/variant-xor.xml
technology: php
version: master
license: CC-BY-3.0
