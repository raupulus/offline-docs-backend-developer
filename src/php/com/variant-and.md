---
title: variant_and
description: Realiza un AND entre dos variantes y devuelve el resultado
source_url: https://www.php.net/manual/es/function.variant-and.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/com/functions/variant-and.xml
technology: php
version: master
license: CC-BY-3.0
...
Realiza un AND entre dos variantes y devuelve el resultado
...
Realiza un AND a nivel de bits, según la tabla de verdad siguiente; note que esto es diferente del AND normal.
