---
title: variant_abs
description: Devuelve el valor absoluto de un variant
source_url: https://www.php.net/manual/es/function.variant-abs.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/com/functions/variant-abs.xml
technology: php
version: master
license: CC-BY-3.0
