---
title: variant_not
description: Ejecuta una negación a nivel de bits sobre un variant
source_url: https://www.php.net/manual/es/function.variant-not.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/com/functions/variant-not.xml
technology: php
version: master
license: CC-BY-3.0
...
Ejecuta una negación a nivel de bits sobre un variant
...
Ejecuta una negación a nivel de bits sobre el argumento `value` y devuelve el resultado.
...
Devuelve la negación. Si `value` vale `null`, el resultado será también `null`.
