---
title: variant_fix
description: Recupera la porción entera de un variant
source_url: https://www.php.net/manual/es/function.variant-fix.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/com/functions/variant-fix.xml
technology: php
version: master
license: CC-BY-3.0
...
Si `value` es negativo, el primer entero negativo mayor o igual al variant es devuelto, de lo contrario esta función devuelve la porción entera del valor de `value`.
