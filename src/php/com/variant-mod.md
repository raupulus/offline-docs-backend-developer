---
title: variant_mod
description: Divide dos variantes y devuelve el resto
source_url: https://www.php.net/manual/es/function.variant-mod.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/com/functions/variant-mod.xml
technology: php
version: master
license: CC-BY-3.0
...
Divide dos variantes y devuelve el resto
...
Divide `left` por `right` y devuelve el resto.
