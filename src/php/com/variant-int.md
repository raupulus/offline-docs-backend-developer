---
title: variant_int
description: Devuelve la parte entera de un variant
source_url: https://www.php.net/manual/es/function.variant-int.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/com/functions/variant-int.xml
technology: php
version: master
license: CC-BY-3.0
...
translation_revision: b8cba40e8
order: 7880
---
...
Si `value` es negativo, el primer entero negativo inferior o igual a este variant es devuelto, de lo contrario esta función devuelve la parte entera del valor de `value`.
