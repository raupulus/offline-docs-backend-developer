---
title: variant_sub
description: Sustrae el valor del variant de la derecha del valor del de la izquierda
source_url: https://www.php.net/manual/es/function.variant-sub.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/com/functions/variant-sub.xml
technology: php
version: master
license: CC-BY-3.0
...
Sustrae el valor del variant de la derecha del valor del de la izquierda
...
| Si | Entonces |
|----|----|
| Ambas expresiones son strings | Sustracción |
| Una expresión es un string y la otra es un carácter | Sustracción |
| Una expresión es numérica y la otra es un string | Sustracción. |
| Ambas expresiones son numéricas | Sustracción |
| Una de las expresiones es NULL | NULL es devuelto |
| Ambas expresiones están vacías | Un string vacío es devuelto |

Reglas de sustracción de los variants
