---
title: variant_eqv
description: Realiza una equivalencia de bits de dos variants
source_url: https://www.php.net/manual/es/function.variant-eqv.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/com/functions/variant-eqv.xml
technology: php
version: master
license: CC-BY-3.0
...
Si cada bit en `left` es igual al bit correspondiente en `right` entonces la función retorna `true`, de lo contrario retorna `false`.
