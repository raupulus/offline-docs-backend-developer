---
title: variant_round
description: Redondea el variant al número especificado de decimales
source_url: https://www.php.net/manual/es/function.variant-round.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/com/functions/variant-round.xml
technology: php
version: master
license: CC-BY-3.0
...
Redondea el variant al número especificado de decimales
...
Devuelve el valor de `value` redondeado a `decimals` decimales.
...
Devuelve el valor redondeado, o `null` en caso de error.
