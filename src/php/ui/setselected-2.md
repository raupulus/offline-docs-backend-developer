...
description: Establece la opción seleccionada
source_url: https://www.php.net/manual/es/ui-controls-radio.setselected.php
source_repo: https://github.com/php/doc-es.git
source_ref: master
source_commit: 954a0d911
source_path: reference/ui/ui/controls/radio/setselected.xml
technology: php
version: master
license: CC-BY-3.0
