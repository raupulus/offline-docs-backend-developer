---
title: The MicroPython Interactive Interpreter Mode (aka REPL)
source_url: https://docs.micropython.org/en/latest/reference/repl.html
source_repo: https://github.com/micropython/micropython.git
source_ref: master
source_commit: 52b5fbcb4
source_path: reference/repl.rst
