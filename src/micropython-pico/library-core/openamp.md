---
title: '`openamp`'
description: provides standard Asymmetric Multiprocessing (AMP) support
source_url: https://docs.micropython.org/en/latest/library/openamp.html
source_repo: https://github.com/micropython/micropython.git
source_ref: master
source_commit: 52b5fbcb4
source_path: library/openamp.rst
