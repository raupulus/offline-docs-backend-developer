---
title: '`string.templatelib`'
description: Template String Support
source_url: https://docs.micropython.org/en/latest/library/string.templatelib.html
source_repo: https://github.com/micropython/micropython.git
source_ref: master
source_commit: 52b5fbcb4
source_path: library/string.templatelib.rst
