---
title: '`micropython`'
description: access and control MicroPython internals
source_url: https://docs.micropython.org/en/latest/library/micropython.html
source_repo: https://github.com/micropython/micropython.git
source_ref: master
source_commit: 52b5fbcb4
source_path: library/micropython.rst
