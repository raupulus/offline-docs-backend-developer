...
description: Learn about support options for Docker products including paid subscriptions
  and community resources
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/support/_index.md
technology: docker
version: main
license: Apache-2.0
...
- Running inside [certain VM or VDI environments](../desktop/setup/vm-vdi.md) (Docker Business only)
...
> [!NOTE]
>
> Support for [running Docker Desktop in a VM or VDI environment](../desktop/setup/vm-vdi.md) is only available to Docker Business customers.
...
- [Mac system requirements](../desktop/setup/install/mac-install.md#system-requirements)
- [Windows system requirements](../desktop/setup/install/windows-install.md#system-requirements)
- [Linux system requirements](../desktop/setup/install/linux/index.md#system-requirements)
