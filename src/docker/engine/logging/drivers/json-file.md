...
source_path: manuals/engine/logging/drivers/json-file.md
technology: docker
version: main
license: Apache-2.0
...
| `labels-regex` | Similar to and compatible with `labels`. A regular expression to match logging-related labels. Used for advanced [log tag options](../log-tags.md).                                                              | `--log-opt labels-regex=^(production_status\|geo)` |
...
| `env-regex`    | Similar to and compatible with `env`. A regular expression to match logging-related environment variables. Used for advanced [log tag options](../log-tags.md).                                                  | `--log-opt env-regex=^(os\|customer)`              |
