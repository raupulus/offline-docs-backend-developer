...
description: Learn how to use the Amazon CloudWatch Logs logging driver with Docker
  Engine
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/engine/logging/drivers/awslogs.md
technology: docker
version: main
license: Apache-2.0
...
the [tag option documentation](../log-tags.md) for details on supported template
substitutions.
