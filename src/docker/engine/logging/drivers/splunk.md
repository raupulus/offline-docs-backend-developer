...
source_path: manuals/engine/logging/drivers/splunk.md
technology: docker
version: main
license: Apache-2.0
...
| `tag`                       | optional | Specify tag for message, which interpret some markup. Default value is `{{.ID}}` (12 characters of the container ID). Refer to the [log tag option documentation](../log-tags.md) for customizing the log tag format.                                                                                                                         |
