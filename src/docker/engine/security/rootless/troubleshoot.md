...
source_path: manuals/engine/security/rootless/troubleshoot.md
technology: docker
version: main
license: Apache-2.0
...
This error occurs when `/etc/subuid` and `/etc/subgid` are not configured. See [Prerequisites](index.md#prerequisites).
...
If you installed Docker with https://get.docker.com/rootless ([Install without packages](index.md#install)),
