...
source_path: manuals/engine/security/trust/trust_key_mng.md
technology: docker
version: main
license: Apache-2.0
...
[manually generated and added to the repository](trust-delegation.md#creating-delegation-keys).
...
* [Automation with content trust](trust-automation.md)
