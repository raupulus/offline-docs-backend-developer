...
source_path: manuals/engine/manage-resources/labels.md
technology: docker
version: main
license: Apache-2.0
...
Add labels to images using the [`LABEL` instruction](../../build/concepts/dockerfile.md#label) in a Dockerfile:
