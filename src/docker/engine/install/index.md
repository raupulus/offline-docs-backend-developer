...
description: Learn how to choose the best method for you to install Docker Engine.
  This client-server application is available on Linux, Mac, Windows, and as a static
  binary.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/engine/install/_index.md
technology: docker
version: main
license: Apache-2.0
...
see: [Overview of Docker Desktop](../../desktop/index.md).
