...
description: Learn how to install Docker Engine on a 32-bit Raspberry Pi OS system.
  These instructions cover the different installation methods, how to uninstall, and
  next steps. Note that 32-bit support will be deprecated in Docker Engine v29 and
  later.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/engine/install/raspberry-pi-os.md
technology: docker
version: main
license: Apache-2.0
...
- Docker Engine comes bundled with
  [Docker Desktop for Linux](../../desktop/setup/install/linux/index.md). This is
