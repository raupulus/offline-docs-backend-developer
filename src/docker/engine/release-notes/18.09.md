...
source_path: manuals/engine/release-notes/18.09.md
technology: docker
version: main
license: Apache-2.0
...
supported at this time, but support will be removed in a future release.
  ...
  The [Overlay2 storage driver](../storage/drivers/overlayfs-driver.md) is now the default for Docker Engine implementations.
