...
source_path: manuals/engine/release-notes/18.06.md
technology: docker
version: main
license: Apache-2.0
...
* Warn when an engine label using a reserved namespace (com.docker.\*, io.docker.\*, or org.dockerproject.\*) is configured, as per [Docker object labels](../manage-resources/labels.md). [moby/moby#36921](https://github.com/moby/moby/pull/36921)
