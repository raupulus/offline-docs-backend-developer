...
source_path: manuals/engine/cli/proxy.md
technology: docker
version: main
license: Apache-2.0
...
For instructions, see [configuring Docker Desktop to use HTTP/HTTPS proxies](../../desktop/settings-and-maintenance/settings.md#proxies).

If you're running Docker Engine without Docker Desktop, refer to
[Configure the Docker daemon to use a proxy](../daemon/proxy.md)
...
and [configure the Docker daemon to use a proxy server](../daemon/proxy.md)
...
[Predefined ARGs](../../build/concepts/dockerfile.md#predefined-args).
