...
source_path: manuals/engine/swarm/admin_guide.md
technology: docker
version: main
license: Apache-2.0
...
1.  If the swarm has auto-lock enabled, you need the unlock key
    ...
    [Lock your swarm to protect its encryption key](swarm-manager-locking.md).
...
6.  If you use auto-lock,
    [rotate the unlock key](swarm-manager-locking.md#rotate-the-unlock-key).
