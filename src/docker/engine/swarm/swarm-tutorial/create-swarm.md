...
source_path: manuals/engine/swarm/swarm-tutorial/create-swarm.md
technology: docker
version: main
license: Apache-2.0
...
After you complete the [tutorial setup](../../../reference/api/ai-governance/index.md) steps, you're ready
