...
source_path: manuals/engine/swarm/manage-nodes.md
technology: docker
version: main
license: Apache-2.0
...
For more information on swarm administration refer to the [Swarm administration guide](admin-guide.md).
...
> swarm. For more information refer to the [Swarm administration guide](admin-guide.md).
...
[Swarm administration guide](admin-guide.md).
