...
source_path: manuals/engine/daemon/ipv6.md
technology: docker
version: main
license: Apache-2.0
...
The built-in default address pool configuration is shown in [Subnet allocation](../network/index.md#subnet-allocation).
...
See [Subnet allocation](../network/index.md#subnet-allocation) for more information about
`default-address-pools`.
