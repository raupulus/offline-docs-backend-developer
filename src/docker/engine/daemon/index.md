...
source_path: manuals/engine/daemon/_index.md
technology: docker
version: main
license: Apache-2.0
...
> using Docker Desktop, refer to the [settings page](../../desktop/settings-and-maintenance/settings.md#docker-engine).
...
When using the [containerd image store](../storage/containerd.md)
...
When using [classic storage drivers](../storage/drivers/index.md)
...
- [Run containerd in the Docker daemon](embedded-containerd.md)
- [Limit a container's resources](../containers/resource-constraints.md)
