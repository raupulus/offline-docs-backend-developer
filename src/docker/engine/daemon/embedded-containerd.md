...
description: Configure Docker Engine to run an experimental containerd server in the
  Docker daemon process
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/engine/daemon/embedded-containerd.md
technology: docker
version: main
license: Apache-2.0
...
[daemon configuration file](index.md#configuration-file):
