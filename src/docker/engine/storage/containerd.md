...
source_path: manuals/engine/storage/containerd.md
technology: docker
version: main
license: Apache-2.0
...
> [Configure the data directory location](../daemon/index.md#configure-the-data-directory-location).
...
- [Configure the data directory](../daemon/index.md#configure-the-data-directory-location)
...
Desktop, see
[containerd image store on Docker Desktop](../../desktop/features/containerd.md).
