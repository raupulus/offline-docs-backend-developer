...
description: Manage product licenses for your organization, including invite-time
  assignment, revocation, and automatic assignment.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/accounts/organization/manage/manage-licenses.md
technology: docker
version: main
license: Apache-2.0
...
> add-ons, see [Docker plans](../../../subscription-billing/plans/index.md),
> or
...
1. Enter the email addresses or Docker IDs of the people you want to invite,
   then assign their
   [role](../../../security/roles-and-permissions/index.md).
...
file limits, see
[Manage organization members](members.md).
...
- When you purchase AI Governance, signing in to
  [Docker Sandboxes](../../../ai/sandboxes/index.md) with the `sbx login`
...
requires
[setting up SSO](../../../security/authentication/single-sign-on/connect.md), then
[provisioning](../../../security/provisioning/index.md) with System
...
- [Docker plans](../../../subscription-billing/plans/index.md) to learn about different
  add-ons
- [Manage seats](manage-seats.md) to add more
  seats to your Docker Core subscription
- [AI Governance plan](../../../subscription-billing/plans/ai-governance.md) to learn
  about AI Governance license usage and billing
- [Docker Offload](../../../offload/about.md) to let your developers offload
