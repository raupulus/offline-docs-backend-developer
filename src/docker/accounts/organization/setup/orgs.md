...
source_path: manuals/accounts/organization/setup/orgs.md
technology: docker
version: main
license: Apache-2.0
...
- Before you create an organization, you need a [Docker ID](../../individual/create-account.md).
...
1. Enter an **Organization namespace**. This is the official, unique name for
   ...
   - If you want to use your Docker ID as the organization name, then you must first [convert your account into an organization](convert-account.md).
