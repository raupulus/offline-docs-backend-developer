...
source_path: manuals/accounts/organization/setup/onboard.md
technology: docker
version: main
license: Apache-2.0
...
- Have a Docker Team or Business subscription. For more details, see
  ...
  > organization, see [Create an organization](orgs.md).

- Familiarize yourself with Docker concepts and terminology in
  the [administration overview](../../index.md).
...
see [Recommended onboarding steps](onboard.md#recommended-onboarding-steps).
...
details, see [Invite members](../manage/members.md) and
[Roles and permissions](../../../security/roles-and-permissions/index.md).
...
For more details, see [Invite members](../manage/members.md) and
[Roles and permissions](../../../security/roles-and-permissions/index.md).
...
subscription, see [Upgrade a plan](../../../subscription-billing/manage/plans.md#upgrade-plans).
...
- [Configure SSO](../../../security/authentication/single-sign-on/connect.md)
  to authenticate and add members when they sign in to Docker through your
  identity provider.
- Optional.
  [Enforce SSO](../../../security/authentication/single-sign-on/connect.md) to
  ...
  > [Enforcing sign-in versus enforcing single sign-on (SSO)](../../../enterprise/security/enforce-sign-in/index.md#enforcing-sign-in-versus-enforcing-single-sign-on-sso).

- [Configure SCIM](../../../security/provisioning/scim/index.md) to
...
and they can circumvent [Docker’s security features](../../../enterprise/security/hardened-desktop/index.md).

There are multiple ways you can enforce sign-in, depending on your organization's
Docker configuration:

- [Registry key method (Windows only)](../../../enterprise/security/enforce-sign-in/methods.md#registry-key-method-windows-only)
- [`.plist` method (Mac only)](../../../enterprise/security/enforce-sign-in/methods.md#plist-method-mac-only)
- [`registry.json` method (All)](../../../enterprise/security/enforce-sign-in/methods.md#registryjson-method-all)
...
- [Image Access Management](../../../enterprise/security/hardened-desktop/image-access-management.md): Control which types of images your developers can pull from Docker Hub.
- [Registry Access Management](../../../enterprise/security/hardened-desktop/registry-access-management.md): Define which registries your developers can access.
...
- Configure [Hardened Docker Desktop](../../../enterprise/security/hardened-desktop/index.md) to improve your organization’s security posture for containerized development.
- [Manage your domains](../../../security/provisioning/domain-management.md) to ensure that all Docker users in your domain are part of your organization.
