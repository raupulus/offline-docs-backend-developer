...
source_path: manuals/accounts/organization/insights.md
technology: docker
version: main
license: Apache-2.0
...
- Administrators must [enforce sign-in](../../enterprise/security/enforce-sign-in/index.md)
  for users
...
- Opted Out Analytics: Whether the user has opted out of the
  [Send usage statistics](../../enterprise/security/hardened-desktop/settings-management/settings-reference.md#send-usage-statistics) setting in Docker Desktop
...
- Turn on **Send usage statistics** in Docker Desktop for all your users.
  ...
  Management](../../enterprise/security/hardened-desktop/settings-management/index.md) and turn on the
...
- Make sure users sign in to an account associated with your
  ...
  sign-in](../../enterprise/security/enforce-sign-in/index.md).
