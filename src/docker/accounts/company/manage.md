...
description: Manage your Docker company in Docker Home. Add organizations, invite
  members, manage owners, resend invitations, export a member CSV, and add subscription
  seats.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/accounts/company/manage.md
technology: docker
version: main
license: Apache-2.0
...
seats, see [Company roles](index.md#company-roles).
...
adding seats, see
[Manage seats](../organization/manage/manage-seats.md#add-seats-to-your-subscription).
...
- [Company overview](index.md)
- [Manage organization members](../organization/manage/members.md)
- [Manage seats](../organization/manage/manage-seats.md)
