...
description: Create a Docker ID with email, Google, or GitHub, then verify your account
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/accounts/individual/create-account.md
technology: docker
version: main
license: Apache-2.0
...
- [Manage a Docker account](manage-account.md)
