...
source_path: manuals/accounts/individual/deactivate-user-account.md
technology: docker
version: main
license: Apache-2.0
...
[Deactivate an organization](../organization/manage/deactivate-account.md).
...
- If you have an active Docker subscription,
  ...
  subscription](../../subscription-billing/plans/docker.md#cancel-a-docker-plan).
...
- If you linked a GitHub or Bitbucket account for automated builds, unlink
  ...
  account](../../docker-hub/repos/manage/builds/link-source.md#unlink-a-github-user-account)
  or
  [Unlink a Bitbucket user
  account](../../docker-hub/repos/manage/builds/link-source.md#unlink-a-bitbucket-user-account).
