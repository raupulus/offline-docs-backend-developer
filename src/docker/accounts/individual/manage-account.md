...
description: Update account settings, email, password, 2FA, tokens, and connected
  accounts
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/accounts/individual/manage-account.md
technology: docker
version: main
license: Apache-2.0
...
[Enable two-factor authentication](../../security/authentication/2fa/index.md).
...
For more information, see
[Create and manage access tokens](../../security/access-tokens/personal-access-tokens.md).
...
organization](../organization/setup/convert-account.md).
...
- [Docker individual accounts overview](index.md)
