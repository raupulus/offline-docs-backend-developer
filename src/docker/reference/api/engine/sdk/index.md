...
description: Learn how to use Docker Engine SDKs to automate Docker tasks in your
  language of choice
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: reference/api/engine/sdk/_index.md
technology: docker
version: main
license: Apache-2.0
...
> ```
>
> For more details, see [the Linux FAQs](../../../../desktop/troubleshoot-and-support/faqs/linuxfaqs.md#how-do-i-use-docker-sdks-with-docker-desktop-for-linux).
