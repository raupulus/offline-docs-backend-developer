...
source_path: reference/compose-file/include.md
technology: docker
version: main
license: Apache-2.0
...
For more information on using `include`, see [Working with multiple Compose files](../../compose/how-tos/multiple-compose-files/index.md)
