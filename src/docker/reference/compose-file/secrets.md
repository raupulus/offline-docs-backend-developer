...
source_path: reference/compose-file/secrets.md
technology: docker
version: main
license: Apache-2.0
...
- `environment`: The secret is created with the value of an environment variable on the host. This is only supported by Docker Compose. It is not supported when deploying with [`docker stack deploy`](../../engine/swarm/stack-deploy.md).
...
For more information, see [How to use secrets in Compose](../../compose/how-tos/use-secrets.md).
