...
source_path: reference/compose-file/develop.md
technology: docker
version: main
license: Apache-2.0
...
Compose to monitor source code for changes. For more information, see [Use Compose Watch](../../compose/how-tos/file-watch.md).
