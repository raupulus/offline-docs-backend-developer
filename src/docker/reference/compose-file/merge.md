...
source_path: reference/compose-file/merge.md
technology: docker
version: main
license: Apache-2.0
...
For more information on how merge can be used to create a composite Compose file, see [Working with multiple Compose files](../../compose/how-tos/multiple-compose-files/index.md)
