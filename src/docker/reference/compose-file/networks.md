...
description: Learn how to configure and control networks using the top-level networks
  element in Docker Compose.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: reference/compose-file/networks.md
technology: docker
version: main
license: Apache-2.0
...
For more information on drivers and available options, see [Network drivers](../../engine/network/drivers/index.md).
...
For more examples, see [Networking in Compose](../../compose/how-tos/networking.md).
