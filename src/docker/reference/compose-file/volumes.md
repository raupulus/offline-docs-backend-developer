...
description: Control how volumes are declared and shared between services using the
  top-level volumes element.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: reference/compose-file/volumes.md
technology: docker
version: main
license: Apache-2.0
...
The `type`, `o`, and `device` keys are passed through to the local driver. For a one-off host-path mount on a single service, see [bind mounts](../../engine/storage/bind-mounts.md).
