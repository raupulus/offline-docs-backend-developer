...
source_path: reference/compose-file/version-and-name.md
technology: docker
version: main
license: Apache-2.0
...
For more information on other ways to name Compose projects, see [Specify a project name](../../compose/how-tos/project-name.md).
