...
source_path: reference/compose-file/models.md
technology: docker
version: main
license: Apache-2.0
...
For more examples and information on using `model`, see [Use AI models in Compose](../../ai/compose/models-and-compose.md)
