---
title: Cloud driver
description: The cloud driver connects Buildx to managed builders in Docker Build
  Cloud.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/build/builders/drivers/cloud.md
technology: docker
version: main
license: Apache-2.0
...
[Docker Build Cloud setup](../../../build-cloud/setup.md). For build examples,
see [Building with Docker Build Cloud](../../../build-cloud/usage.md).
