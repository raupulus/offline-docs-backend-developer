...
description: Learn how to define and use matrix targets in Bake to fork a single target
  into multiple different variants
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/build/bake/matrices.md
technology: docker
version: main
license: Apache-2.0
