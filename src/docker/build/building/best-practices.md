...
source_path: manuals/build/building/best-practices.md
technology: docker
version: main
license: Apache-2.0
...
[spawned with an init process](../../engine/containers/multi-service-container.md),
...
policy](../../scout/policy/index.md#no-outdated-base-images) checks whether the
...
Follow these recommendations on how to properly use the [Dockerfile instructions](../concepts/dockerfile.md)
...
For more information about the `FROM` instruction, see [Dockerfile reference for the FROM instruction](../concepts/dockerfile.md#from).
...
See also [LABEL](../concepts/dockerfile.md#label) in the Dockerfile reference.
...
the [`escape` directive](../concepts/dockerfile.md#escape).
...
For more information about `RUN`, see [Dockerfile reference for the RUN instruction](../concepts/dockerfile.md#run).
...
conjunction with [`ENTRYPOINT`](../concepts/dockerfile.md#entrypoint), unless
you and your expected users are already quite familiar with how `ENTRYPOINT`
works.

For more information about `CMD`, see [Dockerfile reference for the CMD instruction](../concepts/dockerfile.md#cmd).
...
For more information about `EXPOSE`, see [Dockerfile reference for the EXPOSE instruction](../concepts/dockerfile.md#expose).
...
For more information about `ENV`, see [Dockerfile reference for the ENV instruction](../concepts/dockerfile.md#env).
...
- [Dockerfile reference for the ADD instruction](../concepts/dockerfile.md#add)
- [Dockerfile reference for the COPY instruction](../concepts/dockerfile.md#copy)
...
This script uses [the `exec` builtin](https://pubs.opengroup.org/onlinepubs/9699919799/utilities/V3_chap02.html#exec) so that the final running application becomes the container's PID 1. This allows the application to receive any Unix signals sent to the container. For more information, see the [`ENTRYPOINT` reference](../concepts/dockerfile.md#entrypoint).
...
For more information about `ENTRYPOINT`, see [Dockerfile reference for the ENTRYPOINT instruction](../concepts/dockerfile.md#entrypoint).
...
For more information about `VOLUME`, see [Dockerfile reference for the VOLUME instruction](../concepts/dockerfile.md#volume).
...
For more information about `USER`, see [Dockerfile reference for the USER instruction](../concepts/dockerfile.md#user).
...
For more information about `WORKDIR`, see [Dockerfile reference for the `WORKDIR` instruction](../concepts/dockerfile.md#workdir).
...
For more information about `ONBUILD`, see [Dockerfile reference for the ONBUILD instruction](../concepts/dockerfile.md#onbuild).
