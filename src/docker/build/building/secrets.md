...
source_path: manuals/build/building/secrets.md
technology: docker
version: main
license: Apache-2.0
...
use the [`--mount=type=secret`](../concepts/dockerfile.md#run---mounttypesecret)
...
SSH mount](../concepts/dockerfile.md#run---mounttypessh).
