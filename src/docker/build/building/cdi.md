...
source_path: manuals/build/building/cdi.md
technology: docker
version: main
license: Apache-2.0
...
> [Docker Desktop](../../desktop/index.md) is installed and [WSL 2 GPU Paravirtualization](../../desktop/features/gpu.md#prerequisites)
...
Here we use the [`RUN --device` command](../concepts/dockerfile.md#run---device)
...
> [!NOTE]
> [`RUN --device` command](../concepts/dockerfile.md#run---device) is only
