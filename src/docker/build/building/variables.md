...
source_path: manuals/build/building/variables.md
technology: docker
version: main
license: Apache-2.0
...
- [`ARG` Dockerfile reference](../concepts/dockerfile.md#arg)
...
- [`ENV` Dockerfile reference](../concepts/dockerfile.md#env)
...
[Multi-platform arguments](../concepts/dockerfile.md#automatic-platform-args-in-the-global-scope)
...
[Proxy arguments](../concepts/dockerfile.md#predefined-args).
...
[BuildKit built-in build args](../concepts/dockerfile.md#buildkit-built-in-build-args).
