...
description: Introduction to what multi-platform builds are and how to execute them
  using Docker Buildx.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/build/building/multi-platform.md
technology: docker
version: main
license: Apache-2.0
...
[containerd image store](../../desktop/features/containerd.md) by default,
...
- Enable the containerd image store using the
  [daemon configuration file](../../engine/storage/containerd.md).
...
> drivers](../builders/drivers/index.md).
