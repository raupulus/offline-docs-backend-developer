...
source_path: manuals/build/concepts/overview.md
technology: docker
version: main
license: Apache-2.0
...
> For details, see [Difference between `docker build` and `docker buildx build`](../builders/index.md#difference-between-docker-build-and-docker-buildx-build).
