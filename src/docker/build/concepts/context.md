...
source_path: manuals/build/concepts/context.md
technology: docker
version: main
license: Apache-2.0
...
a [Dockerfile](dockerfile.md) and a context.
...
[`BUILDKIT_CONTEXT_KEEP_GIT_DIR` build argument](dockerfile.md#buildkit-built-in-build-args).
...
[Bake](../bake/index.md) is a tool built into `docker build` that
...
- [Using Bake with additional contexts](../bake/contexts.md)
