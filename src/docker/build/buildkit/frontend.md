...
source_path: manuals/build/buildkit/frontend.md
technology: docker
version: main
license: Apache-2.0
...
an external Dockerfile frontend, the first line of your [Dockerfile](../concepts/dockerfile.md)
needs to set the [`syntax` directive](../concepts/dockerfile.md#syntax)
