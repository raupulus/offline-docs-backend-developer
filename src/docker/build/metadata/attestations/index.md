...
source_path: manuals/build/metadata/attestations/_index.md
technology: docker
version: main
license: Apache-2.0
...
[`BUILDX_NO_DEFAULT_ATTESTATIONS`](../../building/variables.md#buildx_no_default_attestations)
...
store. See [containerd image store with Docker Desktop](../../../desktop/features/containerd.md)
or [containerd image store with Docker Engine](../../../engine/storage/containerd.md).
...
[`oci-artifact` option](../../exporters/image-registry.md#synopsis)
