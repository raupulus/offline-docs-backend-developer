...
description: 'The image and registry exporters create an image that can be loaded
  to your
...
source_path: manuals/build/exporters/image-registry.md
technology: docker
version: main
license: Apache-2.0
...
[5]: ../metadata/attestations/index.md#attestations-as-oci-artifacts
