...
description: The OCI and Docker exporters create an image layout tarball on the local
  filesystem
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/build/exporters/oci-docker.md
technology: docker
version: main
license: Apache-2.0
...
The [`docker` driver](../builders/drivers/docker.md) doesn't support these exporters. You
