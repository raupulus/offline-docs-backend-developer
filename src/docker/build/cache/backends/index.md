...
source_path: manuals/build/cache/backends/_index.md
technology: docker
version: main
license: Apache-2.0
...
`gha` cache backends, but only if you have enabled the [containerd image store](../../../desktop/features/containerd.md).
Other cache backends require you to select a different [driver](../../builders/drivers/index.md).
