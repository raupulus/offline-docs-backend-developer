...
source_path: manuals/build/cache/garbage-collection.md
technology: docker
version: main
license: Apache-2.0
...
Depending on the type of [build driver](../builders/drivers/index.md) you use,
...
or if you use Docker Desktop, in [**Settings > Docker Engine**](../../desktop/settings-and-maintenance/settings.md).
