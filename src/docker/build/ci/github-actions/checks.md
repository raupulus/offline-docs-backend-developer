...
description: Discover how to validate your build configuration and identify best practice
  violations using build checks in GitHub Actions.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/build/ci/github-actions/checks.md
technology: docker
version: main
license: Apache-2.0
...
[Build checks](../../checks.md) let you validate your `docker build`
