...
description: Build for multiple architectures with GitHub Actions using QEMU emulation
  or multiple native builders
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/build/ci/github-actions/multi-platform.md
technology: docker
version: main
license: Apache-2.0
...
[Docker GitHub Builder](github-builder/index.md). The reusable workflows
