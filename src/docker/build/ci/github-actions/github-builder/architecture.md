...
description: Learn about the architecture of Docker GitHub Builder, a set of reusable
  workflows for building images and artifacts with BuildKit in GitHub Actions.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/build/ci/github-actions/github-builder/architecture.md
technology: docker
version: main
license: Apache-2.0
