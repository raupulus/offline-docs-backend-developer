...
description: Evaluate Docker Scout policies using the CLI, with built-in and custom
  Rego policies
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/scout/policy/local.md
technology: docker
version: main
license: Apache-2.0
...
[Docker Scout CLI plugin](../install.md) on your runner and run
