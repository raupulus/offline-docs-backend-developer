...
source_path: manuals/scout/how-tos/view-create-sboms.md
technology: docker
version: main
license: Apache-2.0
...
[Image analysis](../explore/analysis.md) uses image SBOMs to understand what packages and versions an image contains.
...
image store](../../desktop/features/containerd.md) feature, or use a `docker-container`
