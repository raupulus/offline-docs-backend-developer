...
description: Create an exception for a vulnerability in an image using the Docker
  Scout Dashboard or Docker Desktop.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/scout/how-tos/create-exceptions-gui.md
technology: docker
version: main
license: Apache-2.0
...
for creating [exceptions](../explore/exceptions.md) for
