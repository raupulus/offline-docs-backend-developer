...
source_path: manuals/scout/how-tos/create-exceptions-vex.md
technology: docker
version: main
license: Apache-2.0
...
- The [containerd image store](../../desktop/features/containerd.md)
...
[containerd image store](../../desktop/features/containerd.md) and write
