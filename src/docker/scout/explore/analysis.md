...
description: Docker Scout image analysis provides a detailed view into the composition
  of your images and the vulnerabilities that they contain
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/scout/explore/analysis.md
technology: docker
version: main
license: Apache-2.0
...
[security advisories](../deep-dive/advisory-db-sources.md).
...
2. Build and push the image that you want to analyze.
   ...
   [build attestations](../../build/metadata/attestations/index.md) to the image. Docker
   ...
   > [containerd image store](../../desktop/features/containerd.md).
...
vulnerability data from [advisory sources](../deep-dive/advisory-db-sources.md).
...
- Attach an [SBOM attestation](../../build/metadata/attestations/sbom.md) at build-time. When an image includes an SBOM attestation, Docker Scout uses it instead of generating one, so the 10 GB limit doesn’t apply.
