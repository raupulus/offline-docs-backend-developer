...
description: 'Learn how to scrape data from Docker Scout using Prometheus to create
  your own
...
source_path: manuals/scout/explore/metrics-exporter.md
technology: docker
version: main
license: Apache-2.0
...
> **Streams**
>
> In Docker Scout, the streams concept is a superset of [environments](../integrations/environment/index.md).
...
To create a PAT, follow the steps in [Create an access token](../../security/access-tokens/personal-access-tokens.md).
...
2. [Create a Docker access token](../../security/access-tokens/personal-access-tokens.md)
...
To revoke a PAT, follow the steps in the [Create and manage access tokens](../../security/access-tokens/personal-access-tokens.md).
