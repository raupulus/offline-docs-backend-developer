...
description: Manage DVP Starter and DVP Growth for organization accounts, including
  how to apply, add consuming domains, and handle billing.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/subscription-billing/plans/docker-verified-publisher.md
technology: docker
version: main
license: Apache-2.0
...
- DVP Starter includes a verified publisher badge, prioritized search
  ranking, [Docker Scout](../../scout/index.md) vulnerability
...
[Insights and analytics](../../docker-hub/repos/manage/trusted-content/insights-analytics.md).
...
1. Select **Apply for DVP**. Sign in if prompted.
1. Select an existing organization namespace, or create a new one if
   needed.
1. Fill in the content you want to publish and select DVP Starter or
   DVP Growth.
1. Submit your application for review with **Submit application**.
1. After approval, Docker emails you a checkout link. Open the link,
