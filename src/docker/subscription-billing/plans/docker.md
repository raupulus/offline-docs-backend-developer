---
title: Docker plans
description: Learn about Docker plans that upgrade personal and organization accounts,
  including usage entitlements, billing cycle, and downgrade options.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/subscription-billing/plans/docker.md
technology: docker
version: main
license: Apache-2.0
...
> [convert your user account into an organization](../../accounts/organization/setup/convert-account.md).
...
[Manage seats](../../accounts/organization/manage/manage-seats.md).

### Docker Offload licenses

[Docker Offload](../../offload/index.md) licenses are available for Docker Team and Docker Business plans. Once assigned to your account, organization owners can [manage license assignments](../../accounts/organization/manage/manage-licenses.md) in Docker Home.
...
Each plan includes a base allocation of [Docker Build Cloud](../../build-cloud/index.md) build minutes per
