---
title: Gordon plans
description: Manage Gordon Plus, Max, and Ultra plans for personal accounts, including
  purchasing, upgrading, and deactivating
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/subscription-billing/plans/gordon.md
technology: docker
version: main
license: Apache-2.0
...
[Gordon](../../ai/gordon/index.md) is an AI assistant for Docker workflows. For pricing details, see the [Gordon product page](https://www.docker.com/products/gordon/).
...
To upgrade to a Gordon paid plan, see [Manage plans](../manage/plans.md).

## Usage

Gordon usage is measured in questions. When you upgrade from Gordon Base to a paid plan, your usage multiplies the Base allowance. Usage is capped across three time windows: 4-hour, daily, and monthly. For full limit details, see [Gordon usage limits](../../ai/gordon/usage-limits.md).
