...
description: Learn how to manage cards, US bank accounts, Stripe Link, and pay by
  invoice for Docker subscriptions.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/subscription-billing/manage/payment-method.md
technology: docker
version: main
license: Apache-2.0
...
To remove your default payment method, first set a different payment method as default, or [downgrade to a free subscription](../plans/docker.md#cancel-a-docker-plan).
