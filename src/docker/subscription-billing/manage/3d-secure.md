...
description: Learn how 3D Secure authentication works for Docker subscription payments
  and how to troubleshoot verification issues.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/subscription-billing/manage/3d-secure.md
technology: docker
version: main
license: Apache-2.0
...
- Starting a [paid subscription](plans.md)
- Changing your [billing cycle](details.md#billing-cycle) from monthly to annual
- [Upgrading your subscription](plans.md#upgrade-plans)
- [Adding seats](../../accounts/organization/manage/manage-seats.md) to an existing
  subscription
