...
description: Learn how to view your Docker billing history, understand what's on an
  invoice, and pay by invoice.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/subscription-billing/manage/history.md
technology: docker
version: main
license: Apache-2.0
...
Renewal dates are set on a per-plan basis, so check each plan individually if you subscribe to more than one. Depending on the product, your billing cycle can be monthly, annual, or another cadence. For plan-specific renewal and billing cycle details, see [Plans](../plans/index.md).
