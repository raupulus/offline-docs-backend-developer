---
title: Manage plans
description: Learn how to set up, upgrade, downgrade, or cancel plans, and how to
  manage auto-renewal and credits.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/subscription-billing/manage/plans.md
technology: docker
version: main
license: Apache-2.0
...
[Credits](index.md#credits).

Credits apply to
[Docker Agentic Platform](../plans/docker-agentic-platform.md).
...
- [Learn about available plans](../plans/index.md)
- [Set up payment information](payment-method.md)
- [View invoices](history.md)
- To learn more about managing your billing details, see [Billing](../index.md).
- To learn about sales tax and VAT, see
  [Taxes](tax-certificate.md).
