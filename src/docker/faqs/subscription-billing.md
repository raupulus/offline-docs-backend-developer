...
description: Frequently asked questions about Docker subscriptions, billing, failed
  payments, taxes, and plans.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/faqs/subscription-billing.md
technology: docker
version: main
license: Apache-2.0
...
[Subscription and billing](../subscription-billing/index.md).
...
instructions, see
[Manage a payment method](../subscription-billing/manage/payment-method.md#manage-payment-method).
...
[Add or update a payment method](../subscription-billing/manage/payment-method.md).
...
[billing information](../subscription-billing/manage/details.md) up to date. For details on
adding a VAT number or submitting a US tax exemption certificate, see
[Taxes](../subscription-billing/manage/tax-certificate.md).
