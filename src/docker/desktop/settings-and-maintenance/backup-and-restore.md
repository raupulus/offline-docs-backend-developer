...
source_path: manuals/desktop/settings-and-maintenance/backup-and-restore.md
technology: docker
version: main
license: Apache-2.0
...
2. Use [`docker push`](/reference/cli/docker/image/push/) to push any
   ...
   > [!TIP]
   >
   > [Set the repository visibility to private](../../docker-hub/repos/index.md) if your image includes sensitive content.
...
To restore volume data, refer to [backup, restore, or migrate data volumes](../../engine/storage/volumes.md#back-up-restore-or-migrate-data-volumes). 
