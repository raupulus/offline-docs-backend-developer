...
source_path: manuals/desktop/setup/vm-vdi.md
technology: docker
version: main
license: Apache-2.0
...
Docker support includes installing and running Docker Desktop within the VM, provided that nested virtualization is correctly enabled. The only hypervisors successfully tested are VMware ESXi and Azure, and there is no support for other VMs. For more information on Docker Desktop support, see [Get support](../../support/index.md).
...
- [Docker Desktop on Microsoft Dev Box](../../enterprise/enterprise-deployment/dev-box.md)
