...
source_path: manuals/desktop/setup/install/windows-permission-requirements.md
technology: docker
version: main
license: Apache-2.0
...
The permissions required to install and run Docker Desktop depend on which [installation mode](windows-install.md#installation-modes) you use.
...
mode](../../../enterprise/security/hardened-desktop/enhanced-container-isolation/index.md) (ECI),
...
> [!NOTE]
>
> Windows containers are only supported in all-users installation mode. They are not available when Docker Desktop is installed per-user. See [Installation modes](windows-install.md#installation-modes).
