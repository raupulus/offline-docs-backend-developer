...
source_path: manuals/desktop/uninstall.md
technology: docker
version: main
license: Apache-2.0
...
> by the application. To preserve important data before uninstalling, refer to the [back up and restore data](settings-and-maintenance/backup-and-restore.md) section.
