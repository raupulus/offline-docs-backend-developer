...
source_path: manuals/desktop/features/wsl/_index.md
technology: docker
version: main
license: Apache-2.0
...
- Met the Docker Desktop for Windows' [system requirements](../../setup/install/windows-install.md#system-requirements).
...
1. [Install Docker Desktop for Windows](../../setup/install/windows-install.md).
...
> Read more about this and other Windows settings at [Changing settings](../../settings-and-maintenance/settings.md)
...
- Enable [Enhanced Container Isolation](../../../enterprise/security/hardened-desktop/enhanced-container-isolation/index.md) to add an additional layer of protection around container workloads regardless of backend.
