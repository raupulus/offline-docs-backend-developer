...
description: Learn how to connect containers to the host, across containers, or through
  proxies and VPNs in Docker Desktop.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/desktop/features/networking/networking-how-tos.md
technology: docker
version: main
license: Apache-2.0
...
For details on how Docker Desktop routes network traffic and file I/O between containers, the VM, and the host, see [Network overview](index.md#overview).
...
For more details, see [How exposed ports work](index.md#how-exposed-ports-work)
...
For details about how this traffic appears to host firewalls and endpoint detection systems, see [Firewalls and endpoint visibility](index.md#firewalls-and-endpoint-visibility).
...
For more details on proxies and proxy configurations, see the [Proxy settings documentation](../../settings-and-maintenance/settings.md#proxies).
...
You can set the following settings on the **Network** tab in the Docker Desktop Dashboard settings, or if you're an admin, with Settings Management via the [`admin-settings.json` file](../../../enterprise/security/hardened-desktop/settings-management/configure-json-file.md#networking), or [Docker Home](../../../enterprise/security/hardened-desktop/settings-management/configure-admin-console.md)
