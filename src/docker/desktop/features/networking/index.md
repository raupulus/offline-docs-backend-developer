...
description: Understand how Docker Desktop handles networking, firewalls, file access,
  proxies, and endpoint visibility.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/desktop/features/networking/_index.md
technology: docker
version: main
license: Apache-2.0
...
- Outbound traffic from the container is sent through Network Address Translation (NAT) using a virtual adapter (typically with an internal IP such as `192.168.65.3`). You can view or change this with the [Docker Desktop settings](../../settings-and-maintenance/settings.md#network).
...
Docker Desktop can use your system’s default proxy settings or custom settings that you configure with [Docker Desktop’s proxy setting](../../settings-and-maintenance/settings.md#proxies).
