...
source_path: manuals/desktop/features/synchronized-file-sharing.md
technology: docker
version: main
license: Apache-2.0
...
- POSIX-style Windows paths are not supported. Avoid setting the [`COMPOSE_CONVERT_WINDOWS_PATHS`](../../compose/how-tos/environment-variables/envvars.md#compose_convert_windows_paths) environment variable in Docker Compose.
