...
description: Learn about Docker Desktop's Virtual Machine Manager options, including
  Docker VMM for Mac and Windows
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/desktop/features/vmm.md
technology: docker
version: main
license: Apache-2.0
...
For more information, see [Docker Desktop WSL 2 backend](wsl/index.md).
