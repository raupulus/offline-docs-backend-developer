...
source_path: manuals/desktop/use-desktop/kubernetes.md
technology: docker
version: main
license: Apache-2.0
...
version, it's slower to provision than `kind`, and it's not supported by [Enhanced Container Isolation](../../reference/api/ai-governance/index.md) (ECI),
...
using the [KubernetesImagesRepository](../../enterprise/security/hardened-desktop/settings-management/configure-json-file.md#kubernetes) setting as follows.
...
> [!NOTE]
>
> In Docker Desktop versions 4.43 or earlier, when using `KubernetesImagesRepository` and [Enhanced Container Isolation (ECI)](../../enterprise/security/hardened-desktop/enhanced-container-isolation/index.md)
> is enabled, add the following images to the [ECI Docker socket mount image list](../../enterprise/security/hardened-desktop/settings-management/configure-json-file.md#enhanced-container-isolation):
>
