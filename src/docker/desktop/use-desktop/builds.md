...
source_path: manuals/desktop/use-desktop/builds.md
technology: docker
version: main
license: Apache-2.0
...
The [build summary](../../build/ci/github-actions/build-summary.md)
...
For more information about managing builders, see [Change settings](../settings-and-maintenance/settings.md#builders)
