...
source_path: manuals/desktop/use-desktop/volumes.md
technology: docker
version: main
license: Apache-2.0
...
The **Volumes** view in Docker Desktop lets you create, inspect, delete, clone, empty, export, and import [Docker volumes](../../engine/storage/volumes.md). You can also browse files and folders in volumes and see which containers are using them.
