...
description: Understand what Docker Desktop Resource Saver mode is and how to configure
  it
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/desktop/use-desktop/resource-saver.md
technology: docker
version: main
license: Apache-2.0
...
[Docker  Desktop WSL docs](../features/wsl/index.md). Finally, since Docker Desktop does not
