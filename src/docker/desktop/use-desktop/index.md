...
description: Learn how to use the Docker Desktop Dashboard within Docker Desktop,
  including Quick search, the Docker menu, and more
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/desktop/use-desktop/_index.md
technology: docker
version: main
license: Apache-2.0
...
- Use [Gordon](../../ai/gordon/index.md), a personal AI assistant embedded in Docker Desktop and the Docker CLI. It's designed to streamline your workflow and help you make the most of the Docker ecosystem.
...
- Access [Docker Hub](../../docker-hub/index.md) to search, browse, pull, run, or view details
  of images.
- Navigate to [Docker Extensions](../../extensions/index.md) if you have enabled it.
