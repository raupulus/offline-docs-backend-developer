...
source_path: manuals/desktop/troubleshoot-and-support/troubleshoot/topics.md
technology: docker
version: main
license: Apache-2.0
...
- Use the [`--user` install flag](../../setup/install/mac-install.md#security-and-access) if appropriate for your setup.
...
in the Apple documentation, and Docker Desktop [Mac system requirements](../../setup/install/mac-install.md#system-requirements).
...
When sharing files from Windows, Docker Desktop sets permissions on [shared volumes](../../settings-and-maintenance/settings.md#file-sharing)
...
In addition to [Hyper-V](#hyper-v) or [WSL 2](../../features/wsl/index.md), virtualization must be turned on. Check the
...
To turn on nested virtualization, see [Run Docker Desktop for Windows in a VM or VDI environment](../../setup/vm-vdi.md#turn-on-nested-virtualization).
...
Try [enabling nested virtualization](../../setup/vm-vdi.md#turn-on-nested-virtualization).
