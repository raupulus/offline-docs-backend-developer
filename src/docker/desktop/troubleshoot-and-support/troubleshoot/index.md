...
source_path: manuals/desktop/troubleshoot-and-support/troubleshoot/_index.md
technology: docker
version: main
license: Apache-2.0
...
- **Reset Kubernetes cluster**. Select to delete all stacks and Kubernetes resources. For more information, see [Kubernetes](../../settings-and-maintenance/settings.md#kubernetes).
...
Run the [`docker desktop diagnose`](../../features/desktop-cli.md) command:
...
- [Get support for Docker products](../../../support/index.md)
