...
source_path: manuals/desktop/troubleshoot-and-support/faqs/general.md
technology: docker
version: main
license: Apache-2.0
...
For details, see [Docker Engine API](../../../reference/api/engine/index.md).
...
Docker Desktop does not support direct USB device passthrough. However, you can use USB over IP to connect common USB devices to the Docker Desktop VM and in turn be forwarded to a container. For more details, see [Using USB/IP with Docker Desktop](../../features/usbip.md).
...
> [!NOTE]
>
> If you are using the WSL 2 backend, first make sure that you meet the [minimum required version](../../features/wsl/best-practices.md) for WSL 2. Otherwise, update WSL 2 first.  
