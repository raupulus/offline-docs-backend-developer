...
source_path: manuals/desktop/troubleshoot-and-support/faqs/windowsfaqs.md
technology: docker
version: main
license: Apache-2.0
...
[Docker Daemon](../../settings-and-maintenance/settings.md#docker-engine)). Docker Desktop ignores
