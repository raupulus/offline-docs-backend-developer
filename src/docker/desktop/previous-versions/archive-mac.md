...
source_path: manuals/desktop/previous-versions/archive-mac.md
technology: docker
version: main
license: Apache-2.0
...
* New
  - Kubernetes Support. You can now run a single-node Kubernetes cluster from the "Kubernetes" Pane in Docker For Mac Preferences and use kubectl commands as well as docker commands. See [the Kubernetes section](../use-desktop/kubernetes.md)
