...
description: Configure popular AI coding assistants and tools to use Docker Model
  Runner as their backend.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/ai/model-runner/ide-integrations.md
technology: docker
version: main
license: Apache-2.0
