...
description: Configure context size, runtime parameters, and model behavior in Docker
  Model Runner.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/ai/model-runner/configuration.md
technology: docker
version: main
license: Apache-2.0
...
See [Models and Compose](../compose/models-and-compose.md) for details on how these are populated.
...
- [Models and Compose](../compose/models-and-compose.md) - Configure models in Compose applications
