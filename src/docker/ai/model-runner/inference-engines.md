...
description: Learn about the llama.cpp, vLLM, and Diffusers inference engines in Docker
  Model Runner.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/ai/model-runner/inference-engines.md
technology: docker
version: main
license: Apache-2.0
...
- [GPU support](../../desktop/features/gpu.md) - GPU configuration for Docker Desktop
