---
title: Dynamic MCP
description: Discover and add MCP servers on-demand using natural language with Dynamic
  MCP servers
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/ai/mcp-catalog-and-toolkit/dynamic-mcp.md
technology: docker
version: main
license: Apache-2.0
...
[MCP Toolkit](toolkit.md) or
[Profiles](profiles.md) are available.

## Prerequisites

To use Dynamic MCP, you need:

- Docker Desktop version 4.50 or later, with [MCP Toolkit](toolkit.md) enabled
...
See [Get started with Docker MCP Toolkit](get-started.md)
