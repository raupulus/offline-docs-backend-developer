...
source_path: manuals/ai/mcp-catalog-and-toolkit/faqs.md
technology: docker
version: main
license: Apache-2.0
...
> [!NOTE]
> When using the images with [Docker MCP gateway](mcp-gateway.md),
...
The [catalog](catalog.md) is the source of
available MCP servers - a library of tools you can choose from.
[Profiles](profiles.md) are collections of
...
- [Open-source MCP Gateway](mcp-gateway.md)
