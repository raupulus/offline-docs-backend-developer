...
source_path: manuals/ai/mcp-catalog-and-toolkit/cli.md
technology: docker
version: main
license: Apache-2.0
...
after adding. See [OAuth authentication](toolkit.md#oauth-authentication).
...
them, see [Custom catalogs](catalog.md#custom-catalogs).
...
For [Dynamic MCP](dynamic-mcp.md), where
