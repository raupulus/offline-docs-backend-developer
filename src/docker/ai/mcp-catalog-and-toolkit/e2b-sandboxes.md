---
title: E2B sandboxes
description: Cloud-based secure sandboxes for AI agents with built-in Docker MCP Gateway
  integration
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/ai/mcp-catalog-and-toolkit/e2b-sandboxes.md
technology: docker
version: main
license: Apache-2.0
...
- [Docker Sandboxes](../sandboxes/index.md)
- [Docker MCP Toolkit and Catalog](index.md)
- [Docker MCP Gateway](mcp-gateway.md)
