...
source_path: manuals/ai/mcp-catalog-and-toolkit/profiles.md
technology: docker
version: main
license: Apache-2.0
...
Catalog](catalog.md) (the source of
...
[OAuth authentication](toolkit.md#oauth-authentication)
for details.
...
See [OAuth authentication](toolkit.md#oauth-authentication)
...
- [Get started with MCP Toolkit](get-started.md)
- [Use MCP Toolkit from the CLI](cli.md)
- [MCP Catalog](catalog.md)
