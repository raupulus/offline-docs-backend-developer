...
description: Browse Docker's curated collection of verified MCP servers, and create
  custom catalogs for your team or organization.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/ai/mcp-catalog-and-toolkit/catalog.md
technology: docker
version: main
license: Apache-2.0
...
to your [profiles](profiles.md), you select
...
[Custom catalogs](cli.md#custom-catalogs)
