...
description: Learn how to define and use AI models in Docker Compose applications
  using the models top-level element
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/ai/compose/models-and-compose.md
technology: docker
version: main
license: Apache-2.0
...
- A platform that supports Compose models such as [Docker Model Runner (DMR)](../model-runner/index.md#requirements).
...
- `runtime_flags`: A list of raw command-line flags passed to the inference engine when the model is started.
   See [Configuration options](../model-runner/configuration.md) for commonly used parameters and examples.
...
When [Docker Model Runner is enabled](../model-runner/index.md):
...
- [Docker Model Runner documentation](../model-runner/index.md)
- [Configuration options](../model-runner/configuration.md) - Context size and runtime parameters
- [Inference engines](../model-runner/inference-engines.md) - llama.cpp and vLLM details
- [API reference](../model-runner/api-reference.md) - OpenAI and Ollama-compatible APIs
