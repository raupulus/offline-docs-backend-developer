---
title: Docker Agent
description: Docker Agent lets you build, orchestrate, and share AI agents that work
  together as a team.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/ai/docker-agent/_index.md
technology: docker
version: main
license: Apache-2.0
...
- Can use external tools via [MCP
  servers](../mcp-catalog-and-toolkit/mcp-gateway.md)
...
reference](../../reference/api/ai-governance/index.md)
...
- Follow the [quickstart](../../reference/api/ai-governance/index.md) to build your first agent
- Learn [best practices](../../reference/api/ai-governance/index.md) for building effective agents
- Integrate Docker Agent with your [editor](../../reference/api/ai-governance/index.md) or use agents as
  [tools in MCP clients](../../reference/api/ai-governance/index.md)
...
- Connect agents to external tools via the [Docker MCP
  Gateway](../mcp-catalog-and-toolkit/mcp-gateway.md)
- Read the full [configuration reference](../../reference/api/ai-governance/index.md)
