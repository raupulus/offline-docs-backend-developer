---
title: Docker Agent
description: 'Use Docker Agent in Docker Sandboxes with multi-provider authentication

  supporting OpenAI, Anthropic, and more.'
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/ai/sandboxes/agents/docker-agent.md
technology: docker
version: main
license: Apache-2.0
...
Official documentation: [Docker Agent](../../docker-agent/index.md)
