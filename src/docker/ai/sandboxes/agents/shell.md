---
title: Shell
description: Run an agent-less sandbox with a Bash login shell for manual setup, testing
  custom agent implementations, or inspecting a running environment.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/ai/sandboxes/agents/shell.md
technology: docker
version: main
license: Apache-2.0
