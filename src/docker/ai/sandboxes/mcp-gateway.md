---
title: MCP gateway
description: Register MCP servers, authorize OAuth-backed servers, and connect MCP
  tools to Docker Sandboxes.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/ai/sandboxes/mcp-gateway.md
technology: docker
version: main
license: Apache-2.0
