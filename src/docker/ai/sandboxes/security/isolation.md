...
description: How Docker Sandboxes isolate AI agents using hypervisor, network, Docker
  Engine, workspace, and credential boundaries.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/ai/sandboxes/security/isolation.md
technology: docker
version: main
license: Apache-2.0
...
Engine](../../../engine/index.md) inside the sandbox environment, isolated from
