...
description: Require Docker Sandboxes users to sign in as members of your organization,
  enforced through endpoint management.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/ai/sandboxes/governance/monitor-and-enforce/sign-in-enforcement.md
technology: docker
version: main
license: Apache-2.0
...
- [Organization policies](../access-controls/organization.md): centrally manage
  ...
  Console
- [Governance overview](../index.md): how local and organization governance fit
  together
- [Enforce sign-in for Docker Desktop](../../../../enterprise/security/enforce-sign-in/index.md):
