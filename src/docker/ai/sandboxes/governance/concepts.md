...
description: The resource model, rule syntax, and evaluation logic behind Docker sandbox
  governance.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/ai/sandboxes/governance/concepts.md
technology: docker
version: main
license: Apache-2.0
...
Teams are the same [teams](../../../accounts/organization/manage/manage-a-team.md)
