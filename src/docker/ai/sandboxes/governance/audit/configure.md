...
description: Configure local and cloud delivery, retention, and history for Docker
  AI Governance Audit Logs.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/ai/sandboxes/governance/audit/configure.md
technology: docker
version: main
license: Apache-2.0
...
Organization owners and users with a [custom role](../../../../security/roles-and-permissions/custom-roles/index.md) that includes AI Governance audit permissions can configure where Docker writes audit events.
...
- Organization owner access, or a [custom role](../../../../security/roles-and-permissions/custom-roles/index.md) with AI Governance audit permissions
