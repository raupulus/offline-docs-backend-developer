...
description: Collect Docker AI Governance audit records from local JSON Lines files
  written by the sandbox daemon.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/ai/sandboxes/governance/audit/local.md
technology: docker
version: main
license: Apache-2.0
