...
description: Control which host paths Docker Sandboxes can mount as workspaces with
  organization filesystem policies.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/ai/sandboxes/governance/access-controls/filesystem.md
technology: docker
version: main
license: Apache-2.0
