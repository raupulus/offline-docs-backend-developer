...
description: Control outbound network access from Docker Sandboxes with local and
  organization policy rules.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/ai/sandboxes/governance/access-controls/network.md
technology: docker
version: main
license: Apache-2.0
