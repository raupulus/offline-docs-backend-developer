...
description: Add skills from Git repositories or import them from supported host agents
  into a store shared with Docker Sandboxes.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/ai/sandboxes/workflows/agent-skills.md
technology: docker
version: main
license: Apache-2.0
