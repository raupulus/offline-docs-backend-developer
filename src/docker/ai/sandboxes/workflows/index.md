...
description: Choose a Docker Sandboxes workflow for agent skills, Git, local development,
  authenticated tools, or headless automation.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/ai/sandboxes/workflows/_index.md
technology: docker
version: main
license: Apache-2.0
