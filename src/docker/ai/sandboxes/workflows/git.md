...
description: Choose a Git workspace mode and manage branches, parallel tasks, and
  signed commits with Docker Sandboxes.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/ai/sandboxes/workflows/git.md
technology: docker
version: main
license: Apache-2.0
