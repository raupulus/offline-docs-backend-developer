...
description: Route sandbox and daemon traffic through a corporate or upstream proxy,
  including PAC files, SOCKS5, and your OS system proxy.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/ai/sandboxes/configuration/upstream-proxy.md
technology: docker
version: main
license: Apache-2.0
