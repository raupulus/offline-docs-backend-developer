...
description: How Docker Sandboxes handle API keys and authentication credentials for
  sandboxed agents.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/ai/sandboxes/configuration/credentials.md
technology: docker
version: main
license: Apache-2.0
...
[Trust boundaries](../security/index.md#trust-boundaries) for how credential isolation
