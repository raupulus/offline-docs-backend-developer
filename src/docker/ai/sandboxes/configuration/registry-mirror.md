...
description: Route Docker Hub template, kit, and in-sandbox Docker image pulls through
  an organization's registry mirror.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/ai/sandboxes/configuration/registry-mirror.md
technology: docker
version: main
license: Apache-2.0
