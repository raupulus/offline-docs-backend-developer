...
description: Field-by-field reference for a kit's spec.yaml, including arguments,
  credentials, network rules, environment, setup, files, agent instructions, and the
  sandbox block.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/ai/sandboxes/customize/kit-reference.md
technology: docker
version: main
license: Apache-2.0
