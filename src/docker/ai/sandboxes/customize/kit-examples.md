---
title: Kit examples
description: Copy-and-adapt spec.yaml snippets for common mixin and sandbox kit patterns
  — static files, install commands, shell customization, background services, setup
  files, Claude Code skills, and agent forks.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/ai/sandboxes/customize/kit-examples.md
technology: docker
version: main
license: Apache-2.0
