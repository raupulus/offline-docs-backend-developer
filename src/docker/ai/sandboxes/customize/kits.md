---
title: Kits
description: Extend a sandbox with tools, credentials, network rules, and configuration
  using declarative YAML artifacts.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/ai/sandboxes/customize/kits.md
technology: docker
version: main
license: Apache-2.0
