...
description: 'Explore deprecated and retired Docker features, products, and open source

  projects, including details on transitioned tools and archived initiatives.'
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/retired.md
technology: docker
version: main
license: Apache-2.0
...
longer maintained, and users are encouraged to use [Docker Desktop](desktop/index.md)
or [Docker Engine](engine/index.md) directly on supported platforms.
...
[Docker Desktop](desktop/index.md) on current systems. References to
...
[`sbx` CLI](ai/sandboxes/index.md) instead.

### Docker Scout features

The following Docker Scout features have been retired or deprecated. For
details, see the [Scout platform release notes](scout/release-notes/platform.md).
...
- Native Amazon ECR integration: automatically analyzed images pushed to ECR
  ...
  [`docker scout watch`](scout/integrations/registry.md).
...
(OATs)](security/access-tokens/organization-access-tokens.md), which provide secure,
...
[Compose v2 Documentation](compose/index.md)
