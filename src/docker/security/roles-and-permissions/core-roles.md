...
source_path: manuals/security/roles-and-permissions/core-roles.md
technology: docker
version: main
license: Apache-2.0
...
[custom roles](custom-roles/index.md)
instead.
...
[Company overview](../../accounts/company/index.md).
...
> to use [custom roles](custom-roles/index.md).
...
- [Company overview](../../accounts/company/index.md): Understand company
