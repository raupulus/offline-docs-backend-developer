...
description: Permissions available for Docker custom roles across organization management,
  Docker Hub, billing, AI Governance, Docker Hardened Images, and Docker Offload.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/security/roles-and-permissions/custom-roles/permissions-reference.md
technology: docker
version: main
license: Apache-2.0
...
- [Manage custom roles](manage.md): Create, assign, and delete custom
  roles
- [Core roles and permissions](../core-roles.md):
