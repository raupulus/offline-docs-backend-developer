...
description: Create, edit, assign, reassign, and delete custom roles in Docker Home
  for organization users and teams
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/security/roles-and-permissions/custom-roles/manage.md
technology: docker
version: main
license: Apache-2.0
