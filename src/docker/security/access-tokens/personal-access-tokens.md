...
description: Create and manage personal Docker access tokens for secure CLI authentication
  and automation
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/security/access-tokens/personal-access-tokens.md
technology: docker
version: main
license: Apache-2.0
...
> [!NOTE]
>
> For organization-wide automation, consider [organization access tokens](organization-access-tokens.md) which aren't tied to individual user accounts.
...
- Use [organization access tokens](organization-access-tokens.md) for organization-wide automation
