...
description: Create and manage OIDC connections in Docker Home, then authenticate
  GitHub Actions to Docker Hub with docker/login-action and short-lived tokens
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/security/authentication/oidc-connections/create-manage.md
technology: docker
version: main
license: Apache-2.0
...
1. Select **Create OIDC connection** and fill in the OIDC connection form.
   ...
   - For rulesets, subject claims, and resources, see
     [OIDC connections rulesets and subject claims](rulesets-claims.md).
