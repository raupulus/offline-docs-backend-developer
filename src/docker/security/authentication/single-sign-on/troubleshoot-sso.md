...
description: Troubleshoot common Docker single sign-on configuration and authentication
  issues
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/security/authentication/single-sign-on/troubleshoot-sso.md
technology: docker
version: main
license: Apache-2.0
...
To manually invite users, see [Invite members](../../../accounts/organization/manage/members.md#invite-members).
...
1. Ensure that the attributes being synced from your IdP match Docker's [supported attributes](../../provisioning/scim/provision-scim.md#supported-attributes) for SCIM.
...
Purchase additional Docker Business subscription seats. For details, see [Manage subscription seats](../../../accounts/organization/manage/manage-seats.md).

**Remove users or pending invitations**

Review your organization members and pending invitations. Remove inactive users or pending invitations to free up seats. For more details, see [Manage organization members](../../../accounts/organization/manage/members.md).
...
Add and verify all domains and subdomains used as UPN by your IdP and associate them with your Docker SSO connection. For details, see [Configure single sign-on](connect.md).
