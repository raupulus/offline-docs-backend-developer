...
description: Connect Docker and your identity provider, test the setup, and enable
  enforcement
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/security/authentication/single-sign-on/connect.md
technology: docker
version: main
license: Apache-2.0
...
If you're unfamiliar with the SSO process, first review [SSO overview](index.md) to learn about how SSO works.
...
1. For **Configure SAML**, input the following values:
   ...
   - Optional. Add [SAML attributes](../../provisioning/index.md#sso-attributes), if required by your org.
...
1. Optional. Add [SAML attributes](../../provisioning/index.md#sso-attributes), if required by your org.
...
1. Repeat steps 3-6 from the [Set up an SSO connection](connect.md#set-up-an-sso-connection) procedures on this page. Repeat these steps for each IdP your organization intends to use.
...
Before enforcing SSO, users accessing Docker through the CLI must [create a personal access token (PAT)](../../access-tokens/personal-access-tokens.md). The PAT replaces their username and password for authentication.
...
- [Provision users](../../provisioning/index.md).
- [Enforce sign-in](../../../enterprise/security/enforce-sign-in/index.md).
- [Create personal access tokens](../../access-tokens/personal-access-tokens.md).
- [Troubleshoot SSO](troubleshoot-sso.md) issues.
