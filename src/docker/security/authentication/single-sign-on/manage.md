...
source_path: manuals/security/authentication/single-sign-on/manage.md
technology: docker
version: main
license: Apache-2.0
...
For more information on provisioning methods, see [Provision users](../../provisioning/index.md).
