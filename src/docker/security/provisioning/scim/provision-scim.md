...
source_path: manuals/security/provisioning/scim/provision-scim.md
technology: docker
version: main
license: Apache-2.0
...
You can assign [Docker roles](../../roles-and-permissions/index.md) to
...
| ------------ | ---------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `dockerRole` | `member`, `editor`, or `owner`           | If not set, the user defaults to the `member` role. Setting this attribute overrides the default.<br><br>For role definitions, see [Roles and permissions](../../roles-and-permissions/index.md).                                        |
...
1. Setup [SSO](../../authentication/single-sign-on/connect.md) and SCIM first.
...
1. Complete the [SCIM provisioning setup](provision-scim.md#enable-scim-in-docker).
...
1. Add or update the following mappings:
   ...
   - Optional. Map `dockerRole`, `dockerOrg`, or `dockerTeam` using one of the
     [mapping methods](provision-scim.md#set-up-role-mapping).
...
- Set up [Group mapping](group-mapping.md).
- [Troubleshoot provisioning](../troubleshoot-provisioning.md).
