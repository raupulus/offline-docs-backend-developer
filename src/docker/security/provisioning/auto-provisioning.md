...
description: Auto-provision users by associating members to your organization when
  email addresses match a verified domain.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/security/provisioning/auto-provisioning.md
technology: docker
version: main
license: Apache-2.0
...
- You may need to [manage seats](../../accounts/organization/manage/manage-seats.md) to accommodate new users.
...
- [SCIM provisioning](scim/index.md) for advanced user management.
- [Group mapping](scim/group-mapping.md) to assign users to teams automatically.
