...
source_path: manuals/compose/install/uninstall.md
technology: docker
version: main
license: Apache-2.0
...
If you want to uninstall Docker Compose and you have installed Docker Desktop, see [Uninstall Docker Desktop](../../desktop/uninstall.md).
