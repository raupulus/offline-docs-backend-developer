...
source_path: manuals/compose/how-tos/dependent-images.md
technology: docker
version: main
license: Apache-2.0
...
Using [Bake](../../build/bake/index.md) let you pass the complete build definition for all services
...
- [Learn about multi-stage Dockerfiles](../../build/building/multi-stage.md)
