...
source_path: manuals/compose/how-tos/environment-variables/envvars-precedence.md
technology: docker
version: main
license: Apache-2.0
...
5. Set in a container image in the [ENV directive](../../../build/concepts/dockerfile.md#env).
