...
description: Learn how to package, publish, and securely run Docker Compose applications
  from OCI-compliant registries.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/compose/how-tos/oci-artifact.md
technology: docker
version: main
license: Apache-2.0
...
Docker Compose supports working with [OCI artifacts](../../docker-hub/repos/manage/hub-images/oci-artifacts.md), allowing you to package and distribute your Compose applications through container registries. This means you can store your Compose files alongside your container images, making it easier to version, share, and deploy your multi-container applications.
...
- [Familiarize yourself with Compose's trust model](../trust-model.md)
- [Learn about OCI artifacts in Docker Hub](../../docker-hub/repos/manage/hub-images/oci-artifacts.md)
