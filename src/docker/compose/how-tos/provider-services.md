...
description: Learn how to use provider services in Docker Compose to integrate external
  capabilities into your applications
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/compose/how-tos/provider-services.md
technology: docker
version: main
license: Apache-2.0
...
> [!TIP]
>
> If you're working with AI models in Compose, use the [`models` top-level element](../../ai/compose/models-and-compose.md) instead.
