...
description: Learn how to configure Docker Compose to use NVIDIA GPUs with CUDA-based
  containers
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/compose/how-tos/gpu-support.md
technology: docker
version: main
license: Apache-2.0
...
Compose services can define GPU device reservations if the Docker host contains such devices and the Docker Daemon is set accordingly. For this, make sure you install the [prerequisites](../../engine/containers/resource-constraints.md#gpu) if you haven't already done so.
