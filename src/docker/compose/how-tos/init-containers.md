...
description: Use pre_start init containers to run setup tasks before a service starts
  in Docker Compose.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/compose/how-tos/init-containers.md
technology: docker
version: main
license: Apache-2.0
...
- [Use lifecycle hooks](lifecycle.md)
- [Control startup order](startup-order.md)
