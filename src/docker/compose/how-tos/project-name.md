...
description: Learn how to set a custom project name in Compose and understand the
  precedence of each method.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/compose/how-tos/project-name.md
technology: docker
version: main
license: Apache-2.0
