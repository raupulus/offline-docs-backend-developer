...
description: Learn how to configure, deploy, and update Docker Compose applications
  for production environments.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/compose/how-tos/production.md
technology: docker
version: main
license: Apache-2.0
...
- [Using multiple Compose files](multiple-compose-files/index.md)
