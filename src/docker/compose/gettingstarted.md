...
description: Follow this hands-on tutorial to learn how to use Docker Compose from
  defining application dependencies to experimenting with commands.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/compose/gettingstarted.md
technology: docker
version: main
license: Apache-2.0
...
- [Installed the latest version of Docker Compose](install/index.md)
...
6. Stop the stack before moving on:
   ...
   For more information on how Compose Watch works, see [Use Compose Watch](how-tos/file-watch.md).
