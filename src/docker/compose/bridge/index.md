...
description: Learn how Compose Bridge transforms Docker Compose files into Kubernetes
  manifests for seamless platform transitions
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/compose/bridge/_index.md
technology: docker
version: main
license: Apache-2.0
...
These outputs are ready for deployment on Docker Desktop with [Kubernetes enabled](../../desktop/settings-and-maintenance/settings.md#kubernetes).  
...
To get started, see [Customize Compose Bridge](customize.md).
