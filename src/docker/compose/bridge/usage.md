...
description: Learn how to use the default Compose Bridge transformation to convert
  Compose files into Kubernetes manifests
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/compose/bridge/usage.md
technology: docker
version: main
license: Apache-2.0
...
> [!IMPORTANT]
>
> Before you deploy your Compose Bridge transformations, make sure you have [enabled Kubernetes](../../desktop/settings-and-maintenance/settings.md#kubernetes) in Docker Desktop.
