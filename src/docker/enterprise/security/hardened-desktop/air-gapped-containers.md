...
description: Restrict outbound container traffic using proxy rules, PAC files, and
  network isolation with Docker Desktop air-gapped containers
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/enterprise/security/hardened-desktop/air-gapped-containers.md
technology: docker
version: main
license: Apache-2.0
...
- [Enforce sign-in](../enforce-sign-in/index.md) enabled to ensure users authenticate with your organization
- A Docker Business subscription
- Configured [Settings Management](settings-management/index.md) with the `admin-settings.json` file to manage organization policies

## Configure air-gapped containers

Add the container proxy to your [`admin-settings.json` file](settings-management/configure-json-file.md). For example:
...
- [Explore Enhanced Container Isolation](enhanced-container-isolation/index.md) to further restrict what containers can do at runtime
- [Understand how Docker Desktop handles host and container networking](../../../desktop/features/networking/index.md)
