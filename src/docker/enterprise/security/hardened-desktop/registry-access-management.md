...
description: Control which container registries developers can access through Docker
  Desktop with Registry Access Management.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/enterprise/security/hardened-desktop/registry-access-management.md
technology: docker
version: main
license: Apache-2.0
...
- [Enforce sign-in](../enforce-sign-in/index.md).
  Registry Access Management only takes effect when users are signed in to
  Docker Desktop with organization credentials.
- Use
  [Organization access tokens (OATs)](../../../security/access-tokens/organization-access-tokens.md)
  for authentication
...
- [Enforce sign-in](../enforce-sign-in/index.md) to
...
- Combine with
  [Enhanced Container Isolation](enhanced-container-isolation/index.md)
