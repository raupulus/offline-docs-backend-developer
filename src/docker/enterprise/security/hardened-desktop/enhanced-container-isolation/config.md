...
description: Configure Docker socket exceptions and advanced settings for Enhanced
  Container Isolation
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/enterprise/security/hardened-desktop/enhanced-container-isolation/config.md
technology: docker
version: main
license: Apache-2.0
...
Create an [`admin-settings.json` file](../settings-management/configure-json-file.md) and add:
...
- Review [Enhanced Container Isolation FAQs](faq.md).
