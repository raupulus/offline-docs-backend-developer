...
description: Known limitations and platform-specific considerations for Enhanced Container
  Isolation
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/enterprise/security/hardened-desktop/enhanced-container-isolation/limitations.md
technology: docker
version: main
license: Apache-2.0
...
Use the Docker Desktop Kubernetes `kind` provisioner (see [Cluster provisioning method](../../../../desktop/use-desktop/kubernetes.md#cluster-provisioning-method)). In this mode, and with ECI turned on, each Kubernetes node runs in an ECI-protected container, providing stronger isolation from the Docker Desktop VM. The `kind` provisioner is also faster and allows for multi-node Kubernetes clusters.
