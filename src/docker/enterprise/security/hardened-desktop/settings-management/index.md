...
description: Understand how Settings Management works, who it's for, and the benefits
  it provides
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/enterprise/security/hardened-desktop/settings-management/_index.md
technology: docker
version: main
license: Apache-2.0
...
- [Docker Home](configure-admin-console.md): Create and assign settings policies via Docker Home. This provides a web-based interface for managing settings
  across your organization.
- [`admin-settings.json` file](configure-json-file.md): Place a configuration file on the
...
For a complete list of settings you can enforce, see the [Settings reference](settings-reference.md).
...
1. [Configuration profiles](../../enforce-sign-in/methods.md#configuration-profiles-method-mac-only) when used to control proxy settings
...
1. Check that you have [added and verified](../../../../security/provisioning/domain-management.md#add-and-verify-a-domain) your organization's domain.
2. [Enforce sign-in](../../enforce-sign-in/index.md) to
   ensure all developers authenticate with your organization.
3. Choose a configuration method:
   - Use the `--admin-settings` installer flag on [macOS](../../../../desktop/setup/install/mac-install.md#install-from-the-command-line) or [Windows](../../../../desktop/setup/install/windows-install.md#install-from-the-command-line) to automatically create the `admin-settings.json`.
   - Manually create and configure the [`admin-settings.json` file](configure-json-file.md).
