...
description: Track and monitor user compliance with Docker Desktop settings policies
  using the reporting dashboard
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/enterprise/security/hardened-desktop/settings-management/compliance-reporting.md
technology: docker
version: main
license: Apache-2.0
...
- [Docker Desktop](../../../../desktop/release-notes.md) installed across your organization
- [A verified domain](../../../../security/authentication/single-sign-on/connect.md)
- [Enforced sign-in](../../enforce-sign-in/index.md) for your organization
