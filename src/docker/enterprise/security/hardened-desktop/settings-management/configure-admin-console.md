...
description: Configure and enforce Docker Desktop settings across your organization
  in Docker Home
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/enterprise/security/hardened-desktop/settings-management/configure-admin-console.md
technology: docker
version: main
license: Apache-2.0
...
- [Docker Desktop](../../../../desktop/release-notes.md) installed
...
- You can verify all applied settings by checking the [`settings-store.json`
  file](../../../../desktop/settings-and-maintenance/settings.md) on your system
