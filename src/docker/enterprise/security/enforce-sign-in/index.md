...
description: Require users to sign in to Docker Desktop to access organization benefits
  and security features
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/enterprise/security/enforce-sign-in/_index.md
technology: docker
version: main
license: Apache-2.0
...
Enforcing Docker Desktop sign-in and [enforcing SSO](../../../security/authentication/single-sign-on/connect.md#enforce-sso) are different features that serve different purposes:
...
- To configure SSO enforcement, see [Enforce SSO](../../../security/authentication/single-sign-on/connect.md).
