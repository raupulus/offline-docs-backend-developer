---
title: PKG installer
description: Understand how to use the PKG installer. Also explore additional configuration
  options.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/enterprise/enterprise-deployment/pkg-install-and-configure.md
technology: docker
version: main
license: Apache-2.0
...
- Explore how to [Enforce sign-in](../security/enforce-sign-in/methods.md#plist-method-mac-only) for your users.
