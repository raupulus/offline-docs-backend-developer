...
description: Step-by-step guide to migrate from Wolfi distribution images to Docker
  Hardened Images
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/dhi/migration/migrate-from-wolfi.md
technology: docker
version: main
license: Apache-2.0
...
allowing you to [verify](../how-to/verify.md) image signatures and
[scan](../how-to/scan.md) for vulnerabilities to ensure the security
...
[multi-stage build](../../build/building/multi-stage.md). All stages in your
...
issues, see the [Troubleshoot](../how-to/troubleshoot.md) guide for common
