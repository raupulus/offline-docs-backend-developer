...
description: Query Docker Hardened Images data programmatically using the DHI GraphQL
  API.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/dhi/tools/api.md
technology: docker
version: main
license: Apache-2.0
...
Hardened Image](../how-to/vex-api.md) for a guided example.
