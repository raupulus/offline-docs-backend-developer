...
description: Connect an AI assistant to the Docker Hardened Images catalog using the
  DHI MCP server to search repositories, inspect images, view SBOMs, and check CVEs.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/dhi/tools/mcp.md
technology: docker
version: main
license: Apache-2.0
...
In your [Docker Agent](../../ai/docker-agent/index.md) YAML configuration, add the
