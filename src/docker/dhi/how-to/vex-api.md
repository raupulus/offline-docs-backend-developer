...
description: Use the DHI GraphQL API to fetch VEX statements and suppressed CVEs for
  a Docker Hardened Image by digest.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/dhi/how-to/vex-api.md
technology: docker
version: main
license: Apache-2.0
...
This is a guided example of using the [DHI API](../tools/api.md)
...
DHI API](../tools/api.md#request-format). The following example
...
feature](customize.md). Query the customized image's own
