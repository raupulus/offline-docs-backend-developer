...
description: Learn how to pull, run, and reference Docker Hardened Images in Dockerfiles,
  CI pipelines, and standard development workflows.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/dhi/how-to/use.md
technology: docker
version: main
license: Apache-2.0
...
see [Migrate to Docker Hardened Images](../migration/index.md).
