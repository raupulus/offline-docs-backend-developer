...
description: Learn how to find, compare, and evaluate Docker Hardened Images using
  the Docker Hub catalog, DHI CLI, and Docker Scout.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/dhi/how-to/search-evaluate.md
technology: docker
version: main
license: Apache-2.0
