...
description: Learn how to mirror an image into your organization's namespace and optionally
  push it to another private registry.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/dhi/how-to/mirror.md
technology: docker
version: main
license: Apache-2.0
...
Organization owners, editors, and members with a [custom role](../../security/roles-and-permissions/custom-roles/index.md)
...
repositories](../../docker-hub/repos/index.md) for details.
