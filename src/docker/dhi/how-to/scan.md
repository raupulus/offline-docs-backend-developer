...
description: Learn how to scan Docker Hardened Images for known vulnerabilities using
  Docker Scout, Grype, or Trivy.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/dhi/how-to/scan.md
technology: docker
version: main
license: Apache-2.0
...
[VEX](../explore/security-concepts/vex.md) attestations. The following scanners can
...
For a full list of supported scanners, see [Scanner integrations](../explore/scanner-integrations.md).
...
Scout with other systems](../../scout/integrations/index.md).
