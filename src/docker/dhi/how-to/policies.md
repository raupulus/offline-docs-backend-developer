...
description: Learn how to hold your own images to Docker Hardened Image security and
  compliance standards using the Docker Scout CLI.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/dhi/how-to/policies.md
technology: docker
version: main
license: Apache-2.0
...
- The [Docker Scout CLI plugin](../../scout/install.md). It's included with
  Docker Desktop.
...
username and a [personal access token](../../security/access-tokens/personal-access-tokens.md) as the
