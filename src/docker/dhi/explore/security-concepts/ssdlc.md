...
description: See how Docker Hardened Images support a secure SDLC by integrating with
  scanning, signing, and debugging tools.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/dhi/explore/security-concepts/ssdlc.md
technology: docker
version: main
license: Apache-2.0
...
Images](../index.md) (DHIs), [Docker
Debug](/reference/cli/docker/debug/), and [Docker
Scout](../../../scout/index.md), teams can add security without losing
velocity.
