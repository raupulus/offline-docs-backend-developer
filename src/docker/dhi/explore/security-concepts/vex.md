...
description: Learn how VEX helps you prioritize real risks by identifying which vulnerabilities
  in Docker Hardened Images are actually exploitable.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/dhi/explore/security-concepts/vex.md
technology: docker
version: main
license: Apache-2.0
...
integrations](../scanner-integrations.md). To scan a DHI with
VEX support, see [Scan Docker Hardened Images](../../how-to/scan.md).
...
Hardened Images](../../how-to/scan.md). To query suppressed CVEs
programmatically by image digest, see [Query suppressed CVEs for a DHI by
digest](../../how-to/vex-api.md).
