...
description: Understand what CVEs are, how Docker Hardened Images reduce exposure,
  and how to scan images for vulnerabilities using popular tools.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/dhi/explore/security-concepts/cves.md
technology: docker
version: main
license: Apache-2.0
