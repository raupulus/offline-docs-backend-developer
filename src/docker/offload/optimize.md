...
source_path: manuals/offload/optimize.md
technology: docker
version: main
license: Apache-2.0
...
For general Dockerfile tips, see [Building best practices](../build/building/best-practices.md).

## dockerignore files

A [`.dockerignore` file](../build/concepts/context.md#dockerignore-files)
