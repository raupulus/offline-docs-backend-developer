...
source_path: manuals/docker-hub/usage/pulls.md
technology: docker
version: main
license: Apache-2.0
...
[organization namespace](../../faqs/accounts.md#whats-an-organization-name-or-namespace).
...
> may cause [abuse rate limiting](index.md#abuse-rate-limit).
