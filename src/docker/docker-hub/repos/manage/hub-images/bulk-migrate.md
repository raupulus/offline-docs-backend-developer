...
description: Learn how to migrate multiple Docker images and tags between organizations
  using scripts and automation.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/docker-hub/repos/manage/hub-images/bulk-migrate.md
technology: docker
version: main
license: Apache-2.0
