...
description: Learn about immutable tags and how they help maintain image version consistency
  on Docker Hub.
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/docker-hub/repos/manage/hub-images/immutable-tags.md
technology: docker
version: main
license: Apache-2.0
