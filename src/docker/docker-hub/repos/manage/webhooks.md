...
source_path: manuals/docker-hub/repos/manage/webhooks.md
technology: docker
version: main
license: Apache-2.0
...
see [Organization teams](access.md#organization-teams).

To create a webhook using the Docker Hub API, authenticate with one of the
following:

- A [personal access token](../../../security/access-tokens/personal-access-tokens.md)
  with delete permissions
- An [organization access token](../../../security/access-tokens/organization-access-tokens.md)
