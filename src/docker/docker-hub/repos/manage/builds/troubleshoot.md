...
source_path: manuals/docker-hub/repos/manage/builds/troubleshoot.md
technology: docker
version: main
license: Apache-2.0
...
3. In Docker Hub, navigate to the build page for the repository that has linked private submodules. (If necessary, [follow the steps here](../../../../reference/api/ai-governance/index.md#configure-automated-builds) to configure the automated build.)
