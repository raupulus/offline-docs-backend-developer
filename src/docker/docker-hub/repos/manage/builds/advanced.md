...
source_path: manuals/docker-hub/repos/manage/builds/advanced.md
technology: docker
version: main
license: Apache-2.0
...
* `hooks/pre_test`
* `hooks/post_test`
* `hooks/pre_push` (only used when executing a build rule or [Automated build](../../../../reference/api/ai-governance/index.md) )
* `hooks/post_push` (only used when executing a build rule or [Automated build](../../../../reference/api/ai-governance/index.md) )
