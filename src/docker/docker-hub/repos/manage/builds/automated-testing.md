...
source_path: manuals/docker-hub/repos/manage/builds/automated-testing.md
technology: docker
version: main
license: Apache-2.0
...
built images to your Docker Hub repository, enable [Automated Builds](../../../../reference/api/ai-governance/index.md).
...
configured on the same page as [automated builds](../../../../reference/api/ai-governance/index.md), however
...
5. Configure the automated build settings as explained in [Automated builds](../../../../reference/api/ai-governance/index.md).
