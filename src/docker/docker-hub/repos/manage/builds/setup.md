...
source_path: manuals/docker-hub/repos/manage/builds/setup.md
technology: docker
version: main
license: Apache-2.0
...
Docker build system, add the [environment variable](../../../../reference/api/ai-governance/index.md#environment-variables-for-builds)
