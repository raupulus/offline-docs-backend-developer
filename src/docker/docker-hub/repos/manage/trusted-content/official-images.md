...
description: 'This article describes how Docker Official Images are created,

  and how you can contribute or leave feedback.'
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/docker-hub/repos/manage/trusted-content/official-images.md
technology: docker
version: main
license: Apache-2.0
