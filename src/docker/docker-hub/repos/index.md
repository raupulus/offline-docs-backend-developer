...
source_path: manuals/docker-hub/repos/_index.md
technology: docker
version: main
license: Apache-2.0
...
- Manage a repository, including how to manage:
   ...
   - [Images](manage/hub-images/index.md): Repositories support diverse
   ...
   - [Automated builds](manage/builds/index.md): Integrate with GitHub or
     Bitbucket for automated builds. Every code change triggers an image
     rebuild, supporting continuous integration and delivery.

   - [Trusted content](manage/trusted-content/index.md): Contribute to Docker
