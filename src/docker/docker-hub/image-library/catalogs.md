...
source_path: manuals/docker-hub/image-library/catalogs.md
technology: docker
version: main
license: Apache-2.0
...
To learn more about MCP servers, see [MCP Catalog and Toolkit](../../ai/mcp-catalog-and-toolkit/index.md).

## AI Models Catalog

The [AI Models Catalog](https://hub.docker.com/catalogs/models/) provides
curated, trusted models that work with [Docker Model
Runner](../../ai/model-runner/index.md). This catalog is designed to make AI
...
coding agent needs to run in a [Docker Sandbox](../../ai/sandboxes/index.md):
