...
description: Speed up your continuous integration pipelines with Docker Build Cloud
  in CI
source_repo: docker/docs
source_ref: main
source_commit: 083f66104
source_path: manuals/build-cloud/ci.md
technology: docker
version: main
license: Apache-2.0
...
- If you are an organization administrator or have permission to create [organization access tokens (OAT)](../security/access-tokens/organization-access-tokens.md), use an OAT and set `DOCKER_ACCOUNT` to your Docker Hub organization name.
...
- Create an [organization access token (OAT)](../security/access-tokens/organization-access-tokens.md). The token must have these permissions:
...
[Build variables](../build/building/variables.md#buildx_builder).
