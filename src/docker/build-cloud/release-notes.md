...
source_path: manuals/build-cloud/release-notes.md
technology: docker
version: main
license: Apache-2.0
...
- Cloud builders now run BuildKit v0.32.1, upgraded from v0.20.0. This spans
  ...
  is an [exporter attribute](../build/exporters/image-registry.md) that
  you pass with `--output`, or an
  [attestation attribute](../build/metadata/attestations/index.md) that
...
- Fixed an error when building
  [Docker Hardened Images](../dhi/index.md) with a cloud builder.
