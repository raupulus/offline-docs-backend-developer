...
source_path: manuals/build-cloud/usage.md
technology: docker
version: main
license: Apache-2.0
...
variable](../build/building/variables.md#buildx_builder) to specify which
...
see [Load results from Docker Build Cloud](../build/exporters/index.md#load-results-from-docker-build-cloud).
...
It is possible to use Docker Build Cloud with a [private registry](builder-settings.md#private-resource-access)
