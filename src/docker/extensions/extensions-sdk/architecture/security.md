...
source_path: manuals/extensions/extensions-sdk/architecture/security.md
technology: docker
version: main
license: Apache-2.0
...
Note that extensions are not restricted to execute binaries that they list in the [host section](metadata.md#host-section) of the extension metadata: since these binaries can contain any code running as user, they can in turn execute any other commands as long as the user has rights to execute them.
