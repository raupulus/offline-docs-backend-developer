...
source_path: manuals/extensions/extensions-sdk/design/mui-best-practices.md
technology: docker
version: main
license: Apache-2.0
...
[UI Styling overview](../../../reference/api/ai-governance/index.md).
...
- Take a look at our [UI styling guide](../../../reference/api/ai-governance/index.md).
