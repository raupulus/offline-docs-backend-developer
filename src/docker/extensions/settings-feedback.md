...
source_path: manuals/extensions/settings-feedback.md
technology: docker
version: main
license: Apache-2.0
...
> [!NOTE]
>
> If you are an [organization owner](../accounts/organization/manage/manage-a-team.md#what-is-an-organization-owner), you can turn off extensions for your users. Open the `settings-store.json` file, and set `"extensionsEnabled"` to `false`.
...
>
> This can also be done with [Hardened Docker Desktop](../enterprise/security/hardened-desktop/index.md)
